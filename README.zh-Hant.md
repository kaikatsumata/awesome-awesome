...
**共 901 筆** / 33 個領域 — 🟢 活躍 447 筆、🟡 中等 202 筆(依 2026-06-29 的 GitHub 中繼資料自動生成)。
...
- 🟢 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) — 依語言分類的ML框架與函式庫經典精選清單 `awesome` ⭐73.1k · 📅2026-06
- 🟢 [awesome-ai-research-writing](https://github.com/Leey21/awesome-ai-research-writing) — 支援AI研究論文撰寫與潤飾的工具與資源集 `awesome` ⭐29.9k · 📅2026-05
...
- 🟢 [paperlists](https://github.com/papercopilot/paperlists) — Paper Copilot的整理資料，依年度以JSON橫跨涵蓋主要會議並持續更新（大型） `paper-list` ⭐945 · 📅2026-02
...
- 🟡 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) — 彙整DL教學、專案與社群的經典清單 `awesome` ⭐28.5k · 📅2025-05
...
- 🟡 [AAAI-2024-Papers](https://github.com/DmitryRyumin/AAAI-2024-Papers) — 涵蓋AAAI 2024創新研究論文的集合 `paper-list` ⭐590 · 📅2025-01
...
- 🔴 [awesome-ai-awesomeness](https://github.com/amusi/awesome-ai-awesomeness) — 彙整AI相關awesome清單的『awesome的awesome』 `awesome` ⭐981 · 📅2023-08
...
- 🟢 [awesome-deep-phenomena](https://github.com/MinghuiChen43/awesome-deep-phenomena) — grokking、雙重下降、樂透假說等DL經驗現象與理論論文清單 `paper-list` ⭐404 · 📅2026-05
...
- 🟢 [awesome-uncertainty-deeplearning](https://github.com/ENSTA-U2IS-AI/awesome-uncertainty-deeplearning) — 涵蓋深度學習預測性不確定性估計的綜述、論文與程式碼的活躍清單 `awesome` ⭐817 · 📅2026-06
...
- 🟡 [Awesome-GFlowNets](https://github.com/zdhNarsil/Awesome-GFlowNets) — 彙整GFlowNet基礎論文、應用與教學的核心清單 `awesome` ⭐501 · 📅2024-10
...
- 🟢 [Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) — 持續更新頂會與期刊的SNN論文與程式碼 `paper-list` ⭐791 · 📅2026-03
...
- 🟢 [Awesome-Mamba-Collection](https://github.com/XiudingCai/Awesome-Mamba-Collection) — 跨領域涵蓋Mamba論文、教學與實作的代表性精選 `paper-list` ⭐743 · 📅2026-06
...
- 🟢 [Awesome-Hyperbolic-Representation-and-Deep-Learning](https://github.com/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning) — 活躍更新雙曲嵌入、雙曲模型與應用的最新論文 `paper-list` ⭐602 · 📅2026-06
- 🟢 [awesome-snn-conference-paper](https://github.com/AXYZdong/awesome-snn-conference-paper) — 彙整SNN領域頂尖會議與期刊論文及程式碼實作的清單 `paper-list` ⭐455 · 📅2026-05
...
- 🟢 [Awesome-LLM-Reasoning-with-NeSy](https://github.com/LAMDA-NeSy/Awesome-LLM-Reasoning-with-NeSy) — 追蹤LLM時代神經符號學習最新動向的清單 `paper-list` ⭐312 · 📅2025-06
- 🟢 [Efficient_Attention_Survey](https://github.com/attention-survey/Efficient_Attention_Survey) — 依硬體效率、稀疏、線性等分類高效注意力機制的綜述 `survey` ⭐299 · 📅2025-12
...
- 🟢 [KAN-Papers](https://github.com/RamtinMoslemi/KAN-Papers) — 從arXiv擷取的KAN論文完整清單 `paper-list` ⭐7 · 📅2026-05
...
- 🔴 [awesome-neuromorphic-hw](https://github.com/open-neuromorphic/awesome-neuromorphic-hw) — SNN的ASIC/FPGA等神經形態硬體論文集 `paper-list` ⭐212 · 📅2023-11
...
- 🟢 [awesome-industrial-anomaly-detection](https://github.com/M-3LAB/awesome-industrial-anomaly-detection) — 工業影像異常/瑕疵偵測的論文與資料集集（非常活躍） `awesome` ⭐3.7k · 📅2026-06
...
- 🟢 [top-cvpr-2025-papers](https://github.com/SkalskiP/top-cvpr-2025-papers) — 精選CVPR 2025重點論文的集合 `paper-list` ⭐889 · 📅2026-04
- 🟢 [Awesome-Open-Vocabulary-Semantic-Segmentation](https://github.com/Qinying-Liu/Awesome-Open-Vocabulary-Semantic-Segmentation) — 開放詞彙/零樣本語意分割論文清單 `paper-list` ⭐886 · 📅2026-05
...
- 🟢 [Awesome-Skeleton-based-Action-Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) — 每月更新的骨架式動作辨識論文清單 `paper-list` ⭐716 · 📅2026-06
- 🟢 [HOI-Learning-List](https://github.com/DirtyHarryLYL/HOI-Learning-List) — 涵蓋資料集、基準與論文的HOI學習清單（活躍） `awesome` ⭐713 · 📅2025-10
- 🟢 [Awesome-Scene-Graph-Generation](https://github.com/ChocoWu/Awesome-Scene-Graph-Generation) — 涵蓋LLM/非LLM方法、2D/3D/影片的活躍場景圖生成清單 `awesome` ⭐688 · 📅2026-06
- 🟢 [Awesome-CVPR2026-CVPR2025-ICCV2025-CVPR2024-ECCV2026-ECCV2024-AIGC](https://github.com/Kobaayyy/Awesome-CVPR2026-CVPR2025-ICCV2025-CVPR2024-ECCV2026-ECCV2024-AIGC) — 彙整主要會議AIGC相關論文與程式碼 `paper-list` ⭐671 · 📅2026-06
- 🟢 [Awesome-Temporal-Action-Detection-Temporal-Action-Proposal-Generation](https://github.com/zhenyingfang/Awesome-Temporal-Action-Detection-Temporal-Action-Proposal-Generation) — 橫跨收集時序動作偵測、提案生成與弱監督 `paper-list` ⭐590 · 📅2026-05
...
- 🟢 [Awesome-Video-Object-Segmentation](https://github.com/gaomingqi/Awesome-Video-Object-Segmentation) — VOS最新論文、資料集與專案集 `awesome` ⭐507 · 📅2026-06
...
- 🟢 [Awesome-Object-Pose-Estimation](https://github.com/CNJianLiu/Awesome-Object-Pose-Estimation) — IJCV2026綜述《Deep Learning-Based Object Pose Estimation》專案頁 `survey` ⭐429 · 📅2026-01
- 🟢 [Awesome-FAS](https://github.com/RizhaoCai/Awesome-FAS) — 人臉防偽/PAD/liveness論文的全面集合 `paper-list` ⭐383 · 📅2026-06
...
- 🟢 [Awesome-Visual-Grounding](https://github.com/linhuixiao/Awesome-Visual-Grounding) — TPAMI 2025綜述，涵蓋REC/phrase grounding/grounding MLLM（活躍） `survey` ⭐319 · 📅2025-11
...
- 🟢 [Awesome-Multimodal-Referring-Segmentation](https://github.com/henghuiding/Awesome-Multimodal-Referring-Segmentation) — 多模態指代分割清單 `awesome` ⭐253 · 📅2026-05
...
- 🟢 [awesome-3D-scene-graphs](https://github.com/DennisRotondi/awesome-3D-scene-graphs) — 含機器人應用的3D場景圖專門清單 `awesome` ⭐129 · 📅2026-06
- 🟢 [awesome-3d-anomaly-detection](https://github.com/M-3LAB/awesome-3d-anomaly-detection) — 點雲與多模態3D異常偵測綜述儲存庫 `awesome` ⭐123 · 📅2026-06
...
- 🟢 [TPAMI26-Awesome-MLLMs-for-Video-Temporal-Grounding](https://github.com/iLearn-Lab/TPAMI26-Awesome-MLLMs-for-Video-Temporal-Grounding) — 以MLLM進行影片時序grounding（VTG-LLM）的最新論文、程式碼與資料集 `paper-list` ⭐94 · 📅2026-06
...
- 🟡 [awesome-point-cloud-registration](https://github.com/XuyangBai/awesome-point-cloud-registration) — 依匹配策略整理的點雲配準論文集 `paper-list` ⭐947 · 📅2024-07
...
- 🟢 [awesome-NeRF-and-3DGS-SLAM](https://github.com/3D-Vision-World/awesome-NeRF-and-3DGS-SLAM) — 運用隱式表示、NeRF與3DGS的SLAM論文集 `paper-list` ⭐2.1k · 📅2026-06
...
- 🟢 [awesome-dust3r](https://github.com/ruili3/awesome-dust3r) — DUSt3R系列幾何基礎模型論文與資源追蹤 `model` ⭐796 · 📅2025-11
- 🟢 [Awesome-AIGC-3D](https://github.com/hitcslj/Awesome-AIGC-3D) — AIGC 3D（生成、紋理、材質）論文集 `awesome` ⭐781 · 📅2026-05
...
- 🟢 [awesome-graphics-libraries](https://github.com/jslee02/awesome-graphics-libraries) — 3D繪圖函式庫精選集 `awesome` ⭐529 · 📅2026-05
...
- 🟢 [awesome-gaussians](https://github.com/longxiang-ai/awesome-gaussians) — 每日從arXiv自動更新的3DGS論文追蹤 `paper-list` ⭐302 · 📅2026-06
- 🟢 [Awesome-Transformer-based-SLAM](https://github.com/KwanWaiPang/Awesome-Transformer-based-SLAM) — Transformer式SLAM的綜述用論文集 `survey` ⭐276 · 📅2026-06
- 🟢 [Awesome-3DGS-SLAM](https://github.com/KwanWaiPang/Awesome-3DGS-SLAM) — 3DGS SLAM綜述用論文集 `survey` ⭐269 · 📅2026-02
- 🟢 [Awesome-Learning-based-VO-VIO](https://github.com/KwanWaiPang/Awesome-Learning-based-VO-VIO) — 學習式視覺里程計（VO/VIO）的綜述用論文集 `survey` ⭐200 · 📅2026-04
...
- 🟢 [Awesome-3D-Reconstruction-and-Generation](https://github.com/PolySummit/Awesome-3D-Reconstruction-and-Generation) — 3D重建與生成的論文與資料集集 `paper-list` ⭐82 · 📅2026-03
- 🟢 [awesome-dynamic-NeRF](https://github.com/pdaicode/awesome-dynamic-NeRF) — 動態場景用NeRF的論文集 `paper-list` ⭐67 · 📅2026-04
- 🟢 [quad-meshing-survey](https://github.com/Bigger-and-Stronger/quad-meshing-survey) — 四邊形網格化相關論文、程式碼與專案集 `survey` ⭐45 · 📅2026-06
...
- 🟢 [awesome-brep-reconstruction](https://github.com/Bigger-and-Stronger/awesome-brep-reconstruction) — B-rep（邊界表示）重建的論文與OSS專案集，定期更新 `survey` ⭐31 · 📅2026-01
- 🟢 [Awesome-Event-based-SLAM](https://github.com/KwanWaiPang/Awesome-Event-based-SLAM) — 事件式SLAM的綜述用論文集 `survey` ⭐24 · 📅2026-01
...
- 🟡 [awesome-4d-generation](https://github.com/cwchenwang/awesome-4d-generation) — 4D生成（text-to-4D等）論文清單 `paper-list` ⭐330 · 📅2024-10
...
- 🟢 [Awesome-Video-Frame-Interpolation](https://github.com/CMLab-Korea/Awesome-Video-Frame-Interpolation) — IEEE TCSVT'26錄取的VFI綜述，體系化250+論文（活躍） `survey` ⭐156 · 📅2026-06
...
- 🟢 [Awesome-Sketch-Based-Applications](https://github.com/MarkMoHR/Awesome-Sketch-Based-Applications) — 基於草圖的應用論文集 `paper-list` ⭐709 · 📅2026-06
- 🟢 [Awesome-Sketch-Synthesis](https://github.com/MarkMoHR/Awesome-Sketch-Synthesis) — 草圖合成(生成)論文集 `paper-list` ⭐569 · 📅2026-06
...
- 🟢 [Awesome-AI4Animation](https://github.com/yunlong10/Awesome-AI4Animation) — AI 動畫生成、插補、上色與製作輔助的論文集 `paper-list` ⭐205 · 📅2026-01
...
- 🟢 [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) — 涵蓋LLM論文、模型、工具與課程最大規模之一的清單 `awesome` ⭐27k · 📅2025-07
...
- 🟢 [awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources) — 彙整多模態生成、Agent、輔助編程、資料處理、訓練與推理等的LLM資料總整理 `awesome` ⭐8.6k · 📅2026-06
- 🟢 [awesome-prompts](https://github.com/ai-boost/awesome-prompts) — 高評價GPTs提示與前沿提示工程論文集 `awesome` ⭐8.3k · 📅2026-06
- 🟢 [Awesome-LLM-Strawberry](https://github.com/hijkzzz/Awesome-LLM-Strawberry) — 聚焦OpenAI o1與推理技法的論文與部落格集 `paper-list` ⭐6.9k · 📅2025-12
- 🟢 [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) — 彙整GPT/ChatGPT提示技法論文與工具的清單 `awesome` ⭐6.1k · 📅2026-06
...
- 🟢 [awesome-data-llm](https://github.com/OpenDataBox/awesome-data-llm) — 《LLM × DATA》綜述官方儲存庫 `survey` ⭐795 · 📅2026-06
- 🟢 [Awesome-Efficient-Reasoning-LLMs](https://github.com/Eclipsess/Awesome-Efficient-Reasoning-LLMs) — 《Stop Overthinking》高效推理綜述（TMLR2025）論文集 `survey` ⭐777 · 📅2026-02
- 🟢 [Awesome-LLMs-as-Judges](https://github.com/CSHaitao/Awesome-LLMs-as-Judges) — 《LLMs-as-Judges》評估方法綜述官方論文集 `survey` ⭐593 · 📅2025-07
...
- 🟢 [awesome-moe-inference](https://github.com/MoE-Inf/awesome-moe-inference) — 彙整MoE模型推理最佳化論文的清單 `paper-list` ⭐403 · 📅2026-03
- 🟢 [Awesome-Inference-Time-Scaling](https://github.com/ThreeSR/Awesome-Inference-Time-Scaling) — 推理時/測試時擴展的論文清單（活躍） `awesome` ⭐393 · 📅2026-06
...
- 📑 [Awesome-Language-Model-on-Graphs](https://github.com/PeterGriffinJin/Awesome-Language-Model-on-Graphs) — 《LLMs on Graphs》TKDE綜述的論文與資源集 `survey` ⭐995 · 📅2025-03
...
- 📑 [ABigSurveyOfLLMs](https://github.com/NiuTrans/ABigSurveyOfLLMs) — 彙整150篇以上LLM相關綜述的集合 `survey` ⭐350 · 📅2025-02
...
- 🟡 [Awesome-Mixture-of-Experts-Papers](https://github.com/codecaution/Awesome-Mixture-of-Experts-Papers) — MoE研究閱讀清單 `paper-list` ⭐668 · 📅2024-10
...
- 🟡 [awesome-llm-pretraining](https://github.com/RUCAIBox/awesome-llm-pretraining) — LLM預訓練的資料、框架與方法資源集 `awesome` ⭐388 · 📅2025-04
...
- 🟡 [Awesome-RAG-Evaluation](https://github.com/YHPeter/Awesome-RAG-Evaluation) — 《Evaluation of RAG: A Survey》官方評估論文清單 `paper-list` ⭐199 · 📅2025-04
...
- 🔴 [awesome-nlg](https://github.com/accelerated-text/awesome-nlg) — NLG整體的資源集（工具/論文/資料） `awesome` ⭐484 · 📅2023-09
...
- 🟢 [Awesome-Text-to-Image](https://github.com/Yutong-Zhou-cv/Awesome-Text-to-Image) — 文字生成影像的綜述式論文清單 `survey` ⭐2.4k · 📅2026-06
...
- 🟢 [Awesome-diffusion-model-for-image-processing](https://github.com/lixinustc/Awesome-diffusion-model-for-image-processing) — 整理復原/增強/編碼/品質評估的diffusion model `survey` ⭐948 · 📅2026-04
...
- 🟢 [Autoregressive-Models-in-Vision-Survey](https://github.com/ChaofanTao/Autoregressive-Models-in-Vision-Survey) — 視覺autoregressive model綜述（TMLR 2025） `survey` ⭐801 · 📅2026-05
...
- 🟢 [Awesome-Video-World-Models-with-AR-Diffusion](https://github.com/gracezhao1997/Awesome-Video-World-Models-with-AR-Diffusion) — AR+diffusion的影片世界模型（演算法/應用/基礎） `awesome` ⭐618 · 📅2026-06
- 🟢 [awesome-discrete-diffusion-models](https://github.com/kuleshov-group/awesome-discrete-diffusion-models) — 專注於離散diffusion model的資源清單 `awesome` ⭐568 · 📅2025-09
...
- 🟢 [Awesome-From-Video-Generation-to-World-Model](https://github.com/ziqihuangg/Awesome-From-Video-Generation-to-World-Model) — 整理從影片生成到世界模型的脈絡 `paper-list` ⭐497 · 📅2026-03
...
- 🟢 [Awesome-Try-On-Models](https://github.com/Zheng-Chong/Awesome-Try-On-Models) — 整理虛擬試穿模型（含2025） `paper-list` ⭐431 · 📅2026-05
...
- 🟢 [Awesome-AIGC-Image-Video-Detection](https://github.com/ant-research/Awesome-AIGC-Image-Video-Detection) — AI生成影像/影片偵測的最新研究集 `paper-list` ⭐426 · 📅2026-06
...
- 🟢 [Awesome-Text-to-Video-Generation](https://github.com/soraw-ai/Awesome-Text-to-Video-Generation) — 依Sora綜述整理的T2V/I2V論文清單 `survey` ⭐257 · 📅2026-03
...
- 🟢 [Awesome-Nano-Banana-images](https://github.com/PicoTrex/Awesome-Nano-Banana-images) — Gemini系Nano Banana生成範例與提示集（公開資料集） `model` ⭐23.1k · 📅2025-12
- 🟢 [awesome-nano-banana-pro-prompts](https://github.com/YouMind-OpenLab/awesome-nano-banana-pro-prompts) — 世界最大規模之一的Nano Banana Pro提示集10,000+/16語言（每日更新） `model` ⭐12.7k · 📅2026-06
...
- 🟢 [awesome-seedance-2-prompts](https://github.com/YouMind-OpenLab/awesome-seedance-2-prompts) — Seedance 2.0影片生成提示2000+（每日更新） `model` ⭐1.5k · 📅2026-06
- 🟢 [awesome-nano-banana-pro](https://github.com/muset-ai/awesome-nano-banana-pro) — Nano Banana Pro的影像與提示範例集 `model` ⭐1.1k · 📅2025-11
- 🟢 [awesome-video-prompts](https://github.com/songguoxs/awesome-video-prompts) — Veo3/Kling/Hailuo用影片提示集 `model` ⭐556 · 📅2025-10
- 🟢 [Awesome-Chinese-Stable-Diffusion](https://github.com/leeguandong/Awesome-Chinese-Stable-Diffusion) — 中文文生圖SD模型集（含Kolors/HunyuanDiT等） `model` ⭐433 · 📅2026-06
- 🟢 [awesome-qwen-prompt-insight](https://github.com/XiaomingX/awesome-qwen-prompt-insight) — Qwen用優質提示的大規模集合 `model` ⭐405 · 📅2026-02
...
- 🟢 [awesome-grok-imagine-prompts](https://github.com/YouMind-OpenLab/awesome-grok-imagine-prompts) — Grok Imagine（xAI）影片生成提示集 `model` ⭐23 · 📅2026-06
...
- 🟡 [Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) — GPT-4o影像生成提示辭典 `model` ⭐575 · 📅2025-05
...
- 🟢 [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) — 可執行的LLM應用/RAG/agent集合 `awesome` ⭐116k · 📅2026-06
- 🟢 [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) — 最大規模的MCP（Model Context Protocol）伺服器集合 `awesome` ⭐89.9k · 📅2026-06
- 🟢 [awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) — Claude Skill/工具的精選 `awesome` ⭐66.2k · 📅2026-05
- 🟢 [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) — Claude Code用skill/hook/slash-command/外掛集 `awesome` ⭐47.5k · 📅2026-04
- 🟢 [awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration) — 將DeepSeek API整合至各類軟體的官方精選 `model` ⭐38k · 📅2026-02
...
- 🟢 [awesome-opensource-ai](https://github.com/alvinreal/awesome-opensource-ai) — 真正開源的AI專案、模型、工具與基礎的精選清單 `awesome` ⭐4k · 📅2026-06
...
- 🟢 [awesome-deepseek-coder](https://github.com/deepseek-ai/awesome-deepseek-coder) — 彙整DeepSeek Coder相關OSS專案的官方清單 `model` ⭐792 · 📅2025-11
- 🟢 [awesome-comfyui](https://github.com/ComfyUI-Workflow/awesome-comfyui) — ComfyUI自訂節點的大規模集合 `awesome` ⭐711 · 📅2025-07
- 🟢 [awesome-gemini-cli](https://github.com/Piebald-AI/awesome-gemini-cli) — Gemini CLI用工具/擴充/資源集 `awesome` ⭐477 · 📅2026-06
...
- 🟢 [Safe-Reinforcement-Learning-Baselines](https://github.com/chauncygu/Safe-Reinforcement-Learning-Baselines) — 彙整Safe RL的baseline與論文的儲存庫 `paper-list` ⭐804 · 📅2026-03
- 🟢 [World-Model](https://github.com/tsinghua-fib-lab/World-Model) — 世界模型的全面綜述（ACM CSUR 2025錄取） `survey` ⭐771 · 📅2025-11
- 🟢 [awesome-exploration-rl](https://github.com/opendilab/awesome-exploration-rl) — 專注於exploration的RL論文清單 `paper-list` ⭐707 · 📅2026-05
...
- 🟢 [Reinforcement-Learning-Papers](https://github.com/yingchengyang/Reinforcement-Learning-Papers) — 依年份整理ICLR/ICML/NeurIPS經典與最新論文 `paper-list` ⭐580 · 📅2026-02
...
- 🟢 [awesome-in-context-rl](https://github.com/dunnolab/awesome-in-context-rl) — In-Context RL論文精選 `paper-list` ⭐303 · 📅2025-09
- 🟢 [awesome-RLVR](https://github.com/opendilab/awesome-RLVR) — 持續更新可驗證獎勵RL（RLVR）論文 `paper-list` ⭐223 · 📅2026-06
- 🟢 [Awesome-Causal-Reinforcement-Learning](https://github.com/libo-huang/Awesome-Causal-Reinforcement-Learning) — 因果RL綜述（TNNLS 2024）官方儲存庫 `survey` ⭐222 · 📅2026-06
...
- 🟢 [Awesome-Embodied-World-Model](https://github.com/tsinghua-fib-lab/Awesome-Embodied-World-Model) — 專注於具身agent用世界模型的論文集 `survey` ⭐124 · 📅2026-05
...
- 🟡 [awesome-game-ai](https://github.com/datamllab/awesome-game-ai) — 以多智能體學習為主的遊戲AI資源集 `awesome` ⭐971 · 📅2024-06
...
- 🟢 [Awesome-Multimodal-Large-Language-Models](https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models) — MLLM領域最知名綜述，全面追蹤架構、訓練與評估 `survey` ⭐17.9k · 📅2026-06
...
- 🟢 [Awesome-Prompt-Adapter-Learning-for-VLMs-CLIP](https://github.com/zhengli97/Awesome-Prompt-Adapter-Learning-for-VLMs-CLIP) — CLIP等VLM用提示/adapter學習方法的精選清單 `paper-list` ⭐780 · 📅2026-06
- 🟢 [Awesome-Spatial-Intelligence-in-VLM](https://github.com/mll-lab-nu/Awesome-Spatial-Intelligence-in-VLM) — VLM空間推理相關論文與基準約200篇（非常活躍） `paper-list` ⭐759 · 📅2026-01
...
- 🟢 [Awesome-Multimodal-Papers](https://github.com/friedrichor/Awesome-Multimodal-Papers) — 多模態研究整體的精選論文集 `awesome` ⭐340 · 📅2026-06
...
- 🟢 [Awesome-MLLM-Tuning](https://github.com/WenkeHuang/Awesome-MLLM-Tuning) — MLLM下游任務調校方法綜述 `paper-list` ⭐100 · 📅2025-08
...
- 🟢 [audio-ai-hub](https://github.com/BinWang28/audio-ai-hub) — 音訊大型語言模型的論文與資源集 `awesome` ⭐935 · 📅2026-06
...
- 🟢 [awesome-ai-voice](https://github.com/wildminder/awesome-ai-voice) — OSS的TTS、語音複製與音樂生成模型集 `model` ⭐356 · 📅2026-04
...
- 🟢 [Awesome-Sign-Language-Processing](https://github.com/VIPL-SLP/Awesome-Sign-Language-Processing) — 手語處理（辨識/翻譯/生成）的全面資源集 `awesome` ⭐253 · 📅2026-05
...
- 🟢 [awesome-llm-speech-to-speech](https://github.com/tleyden/awesome-llm-speech-to-speech) — 基於LLM的speech-to-speech模型/框架集 `awesome` ⭐59 · 📅2025-11
...
- 🟡 [INTERSPEECH-2023-24-Papers](https://github.com/DmitryRyumin/INTERSPEECH-2023-24-Papers) — 涵蓋INTERSPEECH 2023-2024論文的集合 `paper-list` ⭐686 · 📅2024-12
...
- 🟢 [awesome-vla-wam](https://github.com/DravenALG/awesome-vla-wam) — VLA與World Action Model（WAM）研究精選 `awesome` ⭐795 · 📅2026-06
- 🟢 [Embodied-AI-Paper-TopConf](https://github.com/Songwxuan/Embodied-AI-Paper-TopConf) — 持續收集頂會錄取的Embodied AI論文（反映至2026會議，活躍） `paper-list` ⭐697 · 📅2026-05
- 🟢 [Awesome-VLA](https://github.com/yueen-ma/Awesome-VLA) — embodied AI用VLA模型附綜述論文的清單 `survey` ⭐597 · 📅2026-06
- 🟢 [Awesome-VLA-Robotics](https://github.com/Jiaaqiliu/Awesome-VLA-Robotics) — 機器人VLA模型的論文、模型與資料集集 `paper-list` ⭐479 · 📅2026-03
- 🟢 [Awesome-Robotics-Diffusion](https://github.com/showlab/Awesome-Robotics-Diffusion) — 將diffusion model引入機器人學習的最新論文精選清單 `paper-list` ⭐344 · 📅2026-06
- 🟢 [Awesome-Embodied-AI](https://github.com/wadeKeith/Awesome-Embodied-AI) — 涵蓋embodied AI綜述、VLA、資料集與模擬器等 `awesome` ⭐219 · 📅2026-06
- 🟢 [Awesome-VLN](https://github.com/KwanWaiPang/Awesome-VLN) — 視覺語言導航（VLN）綜述用論文集 `survey` ⭐151 · 📅2026-06
- 🟢 [Awesome-VLA](https://github.com/KwanWaiPang/Awesome-VLA) — Vision-Language-Action（VLA）綜述用論文集 `survey` ⭐83 · 📅2026-02
...
- 🟢 [Awesome-TimeSeries-SpatioTemporal-Diffusion-Model](https://github.com/yyysjz1997/Awesome-TimeSeries-SpatioTemporal-Diffusion-Model) — 時序與時空資料用diffusion model的綜述與論文集（活躍） `survey` ⭐997 · 📅2026-02
...
- 🟢 [awesome-gnn-systems](https://github.com/ch-wan/awesome-gnn-systems) — GNN系統與加速相關資源集 `awesome` ⭐345 · 📅2026-06
...
- 🟢 [awesome-molecular-diffusion-models](https://github.com/AzureLeon1/awesome-molecular-diffusion-models) — 分子diffusion model相關論文的精選清單（活躍） `paper-list` ⭐105 · 📅2026-04
...
- 📑 [awesome-pretrain-on-molecules](https://github.com/junxia97/awesome-pretrain-on-molecules) — 化學預訓練模型（IJCAI 2023 survey）的論文清單 `survey` ⭐540 · 📅2023-06
...
- 🟡 [awesome-graph-transformer](https://github.com/wehos/awesome-graph-transformer) — graph transformer論文集 `paper-list` ⭐932 · 📅2025-03
...
- 🟢 [Awesome-LLM4RS-Papers](https://github.com/nancheng58/Awesome-LLM4RS-Papers) — LLM增強推薦系統論文集 `paper-list` ⭐766 · 📅2026-03
...
- 🟢 [awesome-time-series-forecasting](https://github.com/TongjiFinLab/awesome-time-series-forecasting) — 時序預測的論文與程式碼集 `paper-list` ⭐282 · 📅2026-06
- 🟢 [Awesome-Anomaly-Detection-Foundation-Models](https://github.com/mala-lab/Awesome-Anomaly-Detection-Foundation-Models) — 以基礎模型進行異常偵測的論文集 `paper-list` ⭐203 · 📅2026-06
...
- 🟢 [LLMAgentPapers](https://github.com/zjunlp/LLMAgentPapers) — LLM agent的必讀論文集 `paper-list` ⭐3.1k · 📅2026-06
...
- 🟢 [awesome-ai-agent-papers](https://github.com/VoltAgent/awesome-ai-agent-papers) — AI agent研究論文集（工程、記憶、評估、工作流程） `paper-list` ⭐1.5k · 📅2026-05
...
- 🟢 [GUI-Agents-Paper-List](https://github.com/OSU-NLP-Group/GUI-Agents-Paper-List) — GUI agent論文的精選清單 `paper-list` ⭐835 · 📅2026-06
- 🟢 [Awesome-Memory-for-Agents](https://github.com/TsinghuaC3I/Awesome-Memory-for-Agents) — 語言agent記憶（使用者檔案、對話歷史）相關論文集 `paper-list` ⭐587 · 📅2026-06
...
- 🟢 [Awesome-GraphMemory](https://github.com/DEEP-PolyU/Awesome-GraphMemory) — 圖式agent記憶的綜述、論文與基準集 `survey` ⭐304 · 📅2026-06
- 🟡 [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) — AI自主agent（專案/框架）的大規模清單 `awesome` ⭐28.5k · 📅2025-02
...
- 🟢 [awesome-ai-for-science](https://github.com/ai4s-research/awesome-ai-for-science) — 加速物理、化學、生物、材料等科學發現的AI工具與論文集 `awesome` ⭐1.7k · 📅2026-06
...
- 🟢 [awesome-foundation-model-single-cell-papers](https://github.com/OmicsML/awesome-foundation-model-single-cell-papers) — 專注於單細胞基礎模型的論文清單 `paper-list` ⭐485 · 📅2026-06
- 🟢 [Awesome-Radiology-Report-Generation](https://github.com/mk-runner/Awesome-Radiology-Report-Generation) — 放射報告生成的論文、資料集與工具集（非常活躍） `paper-list` ⭐454 · 📅2026-06
- 🟢 [Awesome-LWMs](https://github.com/jaychempan/Awesome-LWMs) — 大型氣象模型（LWMs）集合（AI4Earth） `awesome` ⭐363 · 📅2025-06
...
- 🟢 [Awesome-Earth-Artificial-Intelligence](https://github.com/ESIPFed/Awesome-Earth-Artificial-Intelligence) — 地球科學AI的教學、軟體、資料集與論文集 `awesome` ⭐246 · 📅2026-06
...
- 🟢 [awesome-drug-discovery](https://github.com/yboulaamane/awesome-drug-discovery) — 專注於計算藥物開發方法的精選資源清單 `awesome` ⭐120 · 📅2026-06
- 🟢 [awesome-pathology](https://github.com/open-pathology/awesome-pathology) — 涵蓋數位/計算病理資源（自監督、特徵抽取、資料集等） `awesome` ⭐120 · 📅2026-02
- 🟢 [SurvivalAnalysisPapers](https://github.com/shi-ang/SurvivalAnalysisPapers) — 依類別整理存活分析的論文與資源（活躍） `paper-list` ⭐92 · 📅2026-06
...
- 🟢 [Awesome-AI-Agents-Medicine](https://github.com/AIM-Research-Lab/Awesome-AI-Agents-Medicine) — 醫療用agentic AI最新綜述集 `paper-list` ⭐27 · 📅2026-03
- 🟢 [Awesome-MICCAI-2026](https://github.com/ambicuity/Awesome-MICCAI-2026) — 從arXiv自動收集MICCAI 2026論文由bot每日更新並依領域分類 `paper-list` ⭐27 · 📅2026-06
...
- 🟡 [Awesome-Medical-Large-Language-Models](https://github.com/burglarhobbit/Awesome-Medical-Large-Language-Models) — 精選醫療與健康照護領域LLM論文的集合 `paper-list` ⭐394 · 📅2025-05
- 🟡 [awesome-AI-based-protein-design](https://github.com/opendilab/awesome-AI-based-protein-design) — AI式蛋白質設計的研究論文集 `paper-list` ⭐311 · 📅2024-05
...
- 🟢 [best-of-atomistic-machine-learning](https://github.com/JuDFTteam/best-of-atomistic-machine-learning) — 為約510個原子論機器學習專案評分排名（活躍） `awesome` ⭐698 · 📅2026-06
...
- 🟢 [awesome-materials-informatics](https://github.com/tilde-lab/awesome-materials-informatics) — 現代材料科學中材料資訊學的相關工作集 `awesome` ⭐518 · 📅2026-03
- 🟢 [awesome-digital-humanities](https://github.com/dh-tech/awesome-digital-humanities) — 為人文學者提供的量化與計算方法軟體集（NLP、主題模型、文本分析） `awesome` ⭐388 · 📅2026-05
- 🟢 [AwesomeLLM4SE](https://github.com/iSEngLab/AwesomeLLM4SE) — 整理從需求、開發、測試到維護全SE領域的LLM論文 `survey` ⭐332 · 📅2026-04
- 🟢 [awesome-legal-nlp](https://github.com/maastrichtlawtech/awesome-legal-nlp) — 判決預測、合約分類、判例檢索、法務QA等LegalNLP資源集 `awesome` ⭐331 · 📅2025-10
- 🟢 [awesome-ai-llm4education](https://github.com/GeminiLight/awesome-ai-llm4education) — 收集頂會與期刊的教育用AI/LLM論文 `paper-list` ⭐196 · 📅2026-06
- 🟢 [awesome-pinns](https://github.com/AI-in-Transportation-Lab/awesome-pinns) — PINN/物理資訊機器學習的函式庫、論文與教學精選集 `awesome` ⭐124 · 📅2026-06
- 🟢 [PINN_Paper_List](https://github.com/Event-AHU/PINN_Paper_List) — 物理資訊神經網路（PINN）的論文清單 `paper-list` ⭐84 · 📅2026-06
- 📑 [FinLLMs](https://github.com/adlnlp/FinLLMs) — 論文《Large Language Models in Finance》的相關研究、基準與資料集集 `survey` ⭐378 · 📅2025-04
...
- 🟡 [awesome-ai4eda](https://github.com/Thinklab-SJTU/awesome-ai4eda) — 將AI應用於電子設計自動化（EDA、晶片設計）的論文集 `paper-list` ⭐213 · 📅2023-12
- 🟡 [awesome-ai4lam](https://github.com/AI4LAM/awesome-ai4lam) — 圖書館、檔案館與博物館（GLAM/LAM）用AI的專案、案例與資源集（AI4LAM社群營運） `awesome` ⭐179 · 📅2024-06
...
- 🟢 [Awesome-LLM-Safety](https://github.com/ydyjya/Awesome-LLM-Safety) — LLM安全性的論文、文章、資料集與基準集 `awesome` ⭐1.9k · 📅2026-06
...
- 🟢 [awesome-machine-unlearning](https://github.com/tamlhp/awesome-machine-unlearning) — machine unlearning綜述官方清單，涵蓋方法、資料集與評估指標 `awesome` ⭐961 · 📅2026-05
- 🟢 [awesome-llm-unlearning](https://github.com/chrisliu298/awesome-llm-unlearning) — LLM machine unlearning的論文、綜述與基準集 `paper-list` ⭐601 · 📅2026-06
- 🟢 [awesome-trustworthy-deep-learning](https://github.com/MinghuiChen43/awesome-trustworthy-deep-learning) — OOD泛化、對抗樣本、後門等可信賴性論文（每日更新） `paper-list` ⭐388 · 📅2026-05
...
- 🟢 [Awesome-LMMs-Mechanistic-Interpretability](https://github.com/itsqyh/Awesome-LMMs-Mechanistic-Interpretability) — 探討大型多模態模型內部表示的mechanistic interpretability資源集（活躍） `survey` ⭐212 · 📅2026-03
...
- 🟢 [Awesome-GenAI-Watermarking](https://github.com/and-mill/Awesome-GenAI-Watermarking) — 依影像、音訊、文字整理生成AI模型用浮水印方法（活躍） `awesome` ⭐143 · 📅2026-05
- 🟢 [awesome-mechanistic-interpretability](https://github.com/AI-in-Transportation-Lab/awesome-mechanistic-interpretability) — 將神經網路逆解析為可理解計算元素的mechanistic interpretability資源集 `awesome` ⭐114 · 📅2026-06
...
- 🟡 [awesome-ml-for-cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) — 將ML用於惡意軟體、入侵偵測等的工具、論文與教材經典清單 `awesome` ⭐9k · 📅2024-08
- 🟡 [prompt-injection-defenses](https://github.com/tldrsec/prompt-injection-defenses) — 涵蓋prompt injection的實用與已提出防禦對策 `awesome` ⭐710 · 📅2025-02
...
- 🟡 [OpenRedTeaming](https://github.com/Libr-AI/OpenRedTeaming) — LLM/多模態red teaming論文集（30+方法實作） `paper-list` ⭐168 · 📅2025-05
...
- 🟢 [awesome-computational-social-science](https://github.com/gesiscss/awesome-computational-social-science) — 計算社會科學的書籍、課程與OSS資源全面清單（GESIS營運） `awesome` ⭐907 · 📅2026-05
- 🟢 [Awesome-LLM-in-Social-Science](https://github.com/ValueByte-AI/Awesome-LLM-in-Social-Science) — 將LLM應用於社會科學的論文集 `paper-list` ⭐633 · 📅2026-06
- 🟢 [AwesomeResponsibleAI](https://github.com/AthenaCore/AwesomeResponsibleAI) — 於17個領域彙整負責任AI的研究、書籍、法規、成熟度模型與工具 `awesome` ⭐135 · 📅2026-06
- 🟢 [Awesome-LLM-Psychometrics](https://github.com/ValueByte-AI/Awesome-LLM-Psychometrics) — 以心理測量觀點探討LLM人格、價值觀、心智理論與認知能力的論文集 `survey` ⭐121 · 📅2025-11
...
- 🟢 [Awesome-On-Device-AI-Systems](https://github.com/jeho-lee/Awesome-On-Device-AI-Systems) — 裝置端AI系統（推理引擎/基準/論文），活躍 `awesome` ⭐164 · 📅2026-06
...
- 🟢 [Awesome-ML-SP-Papers](https://github.com/gnipping/Awesome-ML-SP-Papers) — 安全四大頂會的ML Security & Privacy論文集 `paper-list` ⭐356 · 📅2025-11
...
- 🟢 [ML4DB-paper-list](https://github.com/LumingSun/ML4DB-paper-list) — 以AI強化DB系統的論文集（學習式索引、查詢最佳化） `paper-list` ⭐776 · 📅2026-04
- 🟢 [ml-systems-papers](https://github.com/byungsoo-oh/ml-systems-papers) — 系統性收集ML系統領域論文的集合 `paper-list` ⭐626 · 📅2026-02
- 🟢 [awesome-AI-system](https://github.com/lambda7xx/awesome-AI-system) — 彙整AI系統論文及其程式碼的清單 `paper-list` ⭐367 · 📅2026-05
- 🟢 [awesome-vector-database](https://github.com/dangkhoasdc/awesome-vector-database) — 高維向量檢索與資料庫相關的精選清單（活躍） `awesome` ⭐354 · 📅2026-06
- 🟢 [Awesome-LLM-Inference-Engine](https://github.com/sihyeong/Awesome-LLM-Inference-Engine) — 依延遲/吞吐量/記憶體分類LLM推理最佳化方法的全面整理 `survey` ⭐221 · 📅2026-04
...
- 🟡 [Awesome-LLM-Inference](https://github.com/DefTruth/Awesome-LLM-Inference) — LLM/VLM推理最佳化（FlashAttention、PagedAttention、MLA等）的論文與程式碼集 `paper-list` ⭐17 · 📅2025-03
...
- 🟢 [awesome-production-machine-learning](https://github.com/EthicalML/awesome-production-machine-learning) — ML部署、監控與擴展用OSS函式庫清單 `awesome` ⭐20.7k · 📅2026-06
- 🟢 [awesome-mlops](https://github.com/kelvins/awesome-mlops) — MLOps工具的精選清單 `awesome` ⭐5.2k · 📅2026-04
- 🟢 [Awesome-Dataset-Distillation](https://github.com/Guang000/Awesome-Dataset-Distillation) — 涵蓋梯度/分布匹配、生成方法與應用的經典清單（非常活躍） `awesome` ⭐2k · 📅2026-06
- 🟢 [awesome-data-centric-ai](https://github.com/Data-Centric-AI-Community/awesome-data-centric-ai) — 資料中心AI的OSS、教學與研究 `awesome` ⭐352 · 📅2026-04
- 🟢 [awesome-ml-data-quality-papers](https://github.com/SJTU-DMTai/awesome-ml-data-quality-papers) — 涵蓋資料評估、資料歸因與資料選擇/剪枝/coreset `paper-list` ⭐124 · 📅2026-06
...
- 🟢 [Awesome-LLM-Eval](https://github.com/onejune2018/Awesome-LLM-Eval) — LLM評估的工具、基準、排行榜與論文精選清單 `awesome` ⭐647 · 📅2025-11
- 🟢 [Awesome-Datasets-Hub](https://github.com/ahammadmejbah/Awesome-Datasets-Hub) — 醫療AI、NLP、多模態等LLM用資料集集 `awesome` ⭐141 · 📅2026-06
