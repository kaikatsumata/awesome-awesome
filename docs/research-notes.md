...
- 収録総数: **902 件**(実在確認済み)
- 生成日: 2026-06-01(GitHubメタデータ取得時点)
...
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [josephmisiti/awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) | awesome | ML全般 | 72642 | 2026-05 | 言語別のMLフレームワーク・ライブラリの定番キュレーションリスト |
| 🟢 | [academic/awesome-datascience](https://github.com/academic/awesome-datascience) | awesome | データサイエンス | 29301 | 2026-05 | データサイエンスを学び実問題に適用するための定番リソース集 |
| 🟢 | [Leey21/awesome-ai-research-writing](https://github.com/Leey21/awesome-ai-research-writing) | awesome | AI研究執筆支援 | 26555 | 2026-05 | AI研究の論文執筆・推敲を支援するツール・リソース集 |
| 🟢 | [yzhao062/anomaly-detection-resources](https://github.com/yzhao062/anomaly-detection-resources) | awesome | 異常検知(汎用) | 9299 | 2026-03 | 異常検知の書籍・論文・動画・ツールボックスを網羅した定番リスト |
...
| 🟢 | [krzjoa/awesome-python-data-science](https://github.com/krzjoa/awesome-python-data-science) | awesome | Pythonデータサイエンス | 3446 | 2026-04 | Pythonのデータサイエンスソフトウェアを厳選したリスト |
| 🟢 | [endymecy/awesome-deeplearning-resources](https://github.com/endymecy/awesome-deeplearning-resources) | paper-list | DL論文 | 3005 | 2026-01 | DLおよび深層強化学習の論文・コードを時系列で整理 |
| 🟢 | [papercopilot/paperlists](https://github.com/papercopilot/paperlists) | paper-list | 会議論文横断 | 933 | 2026-02 | Paper Copilotの整形済みデータ。主要会議を年度別JSONで横断網羅し継続更新(大型) |
...
| 🟡 | [ChristosChristofidis/awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) | awesome | DL全般 | 28335 | 2025-05 | DLのチュートリアル・プロジェクト・コミュニティを集めた定番リスト |
| 🟡 | [ujjwalkarn/Machine-Learning-Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) | awesome | チュートリアル | 17859 | 2024-06 | 機械学習・深層学習のチュートリアル・記事・リソースの大規模集 |
...
| 📚 | [floodsung/Deep-Learning-Papers-Reading-Roadmap](https://github.com/floodsung/Deep-Learning-Papers-Reading-Roadmap) | paper-list | DL研究ロードマップ | 39508 | 2022-11 | 深層学習の主要論文を学習順に整理した古典的ロードマップ |
| 📚 | [terryum/awesome-deep-learning-papers](https://github.com/terryum/awesome-deep-learning-papers) | paper-list | DL論文(歴史的) | 26142 | 2024-01 | 2012〜2016年の最も引用された重要DL論文Top100 |
| 🔴 | [NirantK/awesome-project-ideas](https://github.com/NirantK/awesome-project-ideas) | awesome | プロジェクトアイデア | 9125 | 2023-03 | ML/NLP/Vision/推薦のプロジェクトアイデアを集めたリスト |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [Thinklab-SJTU/awesome-ml4co](https://github.com/Thinklab-SJTU/awesome-ml4co) | paper-list | 組合せ最適化×ML | 2125 | 2026-05 | 組合せ最適化への機械学習適用論文を36分野超で網羅(活発) |
...
| 🟡 | [hurshd0/must-read-papers-for-ml](https://github.com/hurshd0/must-read-papers-for-ml) | paper-list | ML/DL必読論文 | 1352 | 2023-12 | データサイエンス・ML/DLエンジニア向けの必読論文集(古典含む) |
...
| 🟡 | [materials-data-facility/awesome-bayesian-optimization](https://github.com/materials-data-facility/awesome-bayesian-optimization) | awesome | ベイズ最適化 | 50 | 2024-04 | 材料科学・化学向けベイズ最適化のソフト/論文/チュートリアル集 |
...
| 🟢 | [janosh/awesome-normalizing-flows](https://github.com/janosh/awesome-normalizing-flows) | awesome | 正規化フロー | 1627 | 2026-03 | 正規化フローの論文・実装(PyTorch/JAX/Julia)・動画を集めた代表的リスト |
| 🟢 | [valeman/awesome-conformal-prediction](https://github.com/valeman/awesome-conformal-prediction) | awesome | コンフォーマル予測 | 1231 | 2026-05 | 分布フリー不確実性定量化(CP)の動画・論文・ライブラリを集めた充実リスト |
| 🟢 | [ENSTA-U2IS-AI/awesome-uncertainty-deeplearning](https://github.com/ENSTA-U2IS-AI/awesome-uncertainty-deeplearning) | awesome | 不確実性推定 | 811 | 2026-05 | 深層学習の予測的不確実性推定のサーベイ・論文・コードを網羅した活発なリスト |
...
| 🔴 | [matthewvowels1/Awesome-VAEs](https://github.com/matthewvowels1/Awesome-VAEs) | paper-list | VAE | 842 | 2021-07 | VAE・ディスエンタングルメント・表現学習・生成モデルの論文を約900件集約 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [mintisan/awesome-kan](https://github.com/mintisan/awesome-kan) | awesome | KAN | 3240 | 2026-06 | KANのライブラリ・実装・論文・チュートリアルを網羅する事実上の標準リスト |
...
| 🟢 | [AXYZdong/awesome-snn-conference-paper](https://github.com/AXYZdong/awesome-snn-conference-paper) | paper-list | SNN | 451 | 2026-05 | SNN分野の難関会議・誌論文とコード実装をまとめたリスト |
...
| 🟢 | [LAMDA-NeSy/Awesome-LLM-Reasoning-with-NeSy](https://github.com/LAMDA-NeSy/Awesome-LLM-Reasoning-with-NeSy) | paper-list | neuro-symbolic(LLM) | 299 | 2025-06 | LLM時代のニューロシンボリック学習の最新動向を追うリスト |
...
| 🟡 | [krishnakumarsekar/awesome-quantum-machine-learning](https://github.com/krishnakumarsekar/awesome-quantum-machine-learning) | awesome | 量子ML | 3556 | 2024-05 | QMLの基礎・アルゴリズム・教材・プロジェクトを大規模に収集 |
| 🟡 | [artix41/awesome-quantum-ml](https://github.com/artix41/awesome-quantum-ml) | paper-list | 量子ML | 526 | 2024-06 | 量子デバイス上で動くMLアルゴリズムの論文・資料キュレーション |
...
| 🟡 | [qingsongedu/Awesome-SSL4TS](https://github.com/qingsongedu/Awesome-SSL4TS) | paper-list | 時系列SSL | 377 | 2024-04 | 時系列向け自己教師あり学習(SSL4TS)の論文・コード・データ集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [zhaoxin94/awesome-domain-adaptation](https://github.com/zhaoxin94/awesome-domain-adaptation) | awesome | ドメイン適応 | 5438 | 2025-12 | ドメイン適応に関する論文・コードを集めた定番リスト |
| 🟢 | [tim-learn/awesome-test-time-adaptation](https://github.com/tim-learn/awesome-test-time-adaptation) | awesome | テスト時適応 | 1279 | 2025-11 | SFDA/TTBA/TTIA/OTTA等を網羅したテスト時適応の定番リスト |
| 🟢 | [Vanint/Awesome-LongTailed-Learning](https://github.com/Vanint/Awesome-LongTailed-Learning) | survey | 長尾学習 | 1018 | 2025-11 | TPAMI2023サーベイ対応。クラス再均衡/情報拡張/モジュール改善で分類 |
| 🟢 | [huytransformer/Awesome-Out-Of-Distribution-Detection](https://github.com/huytransformer/Awesome-Out-Of-Distribution-Detection) | awesome | OOD検出 | 1005 | 2026-04 | OOD検出と汎化のベンチマーク・論文・ライブラリを網羅 |
...
| 🟢 | [baifanxxx/awesome-active-learning](https://github.com/baifanxxx/awesome-active-learning) | awesome | 能動学習 | 800 | 2026-03 | 能動学習の論文・ツール・ベンチマークを集めたリスト |
...
| 🟡 | [jindongwang/transferlearning](https://github.com/jindongwang/transferlearning) | paper-list | 転移学習 | 14330 | 2025-02 | 転移学習分野の最大級リポジトリ。論文・コード・データセットを網羅 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [amusi/CVPR2026-Papers-with-Code](https://github.com/amusi/CVPR2026-Papers-with-Code) | paper-list | 会議論文(CVPR) | 22628 | 2026-03 | CVPR 2026の論文とオープンソースプロジェクトの大規模集約(定番) |
| 🟢 | [M-3LAB/awesome-industrial-anomaly-detection](https://github.com/M-3LAB/awesome-industrial-anomaly-detection) | awesome | 産業異常検知 | 3572 | 2026-05 | 産業画像の異常/欠陥検出の論文・データセット集(非常に活発) |
...
| 🟢 | [subeeshvasu/Awesome-Deblurring](https://github.com/subeeshvasu/Awesome-Deblurring) | awesome | デブラー | 2887 | 2025-06 | 画像・動画デブラーのリソースをまとめたリスト |
| 🟢 | [amusi/ICCV2025-Papers-with-Code](https://github.com/amusi/ICCV2025-Papers-with-Code) | paper-list | 会議論文(ICCV) | 2877 | 2025-07 | ICCV 2025の論文とオープンソースプロジェクト集 |
...
| 🟢 | [luanshiyinyang/awesome-multiple-object-tracking](https://github.com/luanshiyinyang/awesome-multiple-object-tracking) | awesome | 多物体追跡 | 1477 | 2025-10 | MOTのレビュー論文・年別アルゴリズム・データセットを整理 |
...
| 🟢 | [YichiZhang98/SAM4MIS](https://github.com/YichiZhang98/SAM4MIS) | paper-list | 医用画像SAM | 1106 | 2026-04 | 医用画像セグメンテーションへのSAM応用論文・OSSの要約 |
...
| 🟢 | [SkalskiP/top-cvpr-2025-papers](https://github.com/SkalskiP/top-cvpr-2025-papers) | paper-list | 会議論文(CVPR) | 878 | 2026-04 | CVPR 2025の注目論文を厳選したコレクション |
| 🟢 | [Qinying-Liu/Awesome-Open-Vocabulary-Semantic-Segmentation](https://github.com/Qinying-Liu/Awesome-Open-Vocabulary-Semantic-Segmentation) | paper-list | オープン語彙セグメンテーション | 877 | 2026-05 | オープン語彙/ゼロショットセマンティックセグメンテーション論文リスト |
...
| 🟢 | [firework8/Awesome-Skeleton-based-Action-Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) | paper-list | スケルトン行動認識 | 711 | 2026-05 | スケルトンベース行動認識の論文を月次更新するリスト |
...
| 🟢 | [ChocoWu/Awesome-Scene-Graph-Generation](https://github.com/ChocoWu/Awesome-Scene-Graph-Generation) | awesome | Scene Graph | 671 | 2026-05 | LLM/非LLM手法・2D/3D/動画を網羅する活発なシーングラフ生成リスト |
...
| 🟢 | [TaoWangzj/Awesome-Face-Restoration](https://github.com/TaoWangzj/Awesome-Face-Restoration) | paper-list | 顔復元 | 491 | 2026-03 | 顔復元手法の論文・リポジトリを集めたリスト |
...
| 🟢 | [CNJianLiu/Awesome-Object-Pose-Estimation](https://github.com/CNJianLiu/Awesome-Object-Pose-Estimation) | survey | 6D姿勢推定 | 421 | 2026-01 | IJCV2026サーベイ「Deep Learning-Based Object Pose Estimation」のプロジェクトページ |
...
| 🟢 | [GuoleiSun/Awesome-SAM2](https://github.com/GuoleiSun/Awesome-SAM2) | paper-list | SAM2/動画 | 150 | 2025-10 | 画像・動画向けSAM2の論文・コード集 |
...
| 🟢 | [M-3LAB/awesome-3d-anomaly-detection](https://github.com/M-3LAB/awesome-3d-anomaly-detection) | awesome | 3D異常検知 | 113 | 2026-06 | 点群・マルチモーダル3D異常検出のサーベイリポジトリ |
...
| 🟡 | [amusi/ECCV2024-Papers-with-Code](https://github.com/amusi/ECCV2024-Papers-with-Code) | paper-list | 会議論文(ECCV) | 2277 | 2024-08 | ECCV 2024の論文とオープンソースプロジェクト集 |
...
| 🟡 | [bismex/Awesome-person-re-identification](https://github.com/bismex/Awesome-person-re-identification) | awesome | Person ReID | 1348 | 2024-06 | 教師あり/教師なし/クロスモーダルReIDを網羅した大規模論文リスト |
...
| 📚 | [jbhuang0604/awesome-computer-vision](https://github.com/jbhuang0604/awesome-computer-vision) | awesome | CV全般 | 23300 | 2024-05 | CV全般の書籍・講義・論文・ツール・データセットを網羅した定番リスト |
...
| 🔴 | [mrgloom/awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) | awesome | セマンティックセグメンテーション | 10836 | 2021-05 | セマンティックセグメンテーションの定番リソース集 |
...
| 🔴 | [hwalsuklee/awesome-deep-text-detection-recognition](https://github.com/hwalsuklee/awesome-deep-text-detection-recognition) | paper-list | テキスト検出・認識 | 2524 | 2021-08 | 深層学習ベースのテキスト検出/認識論文を整理 |
...
| 🔴 | [polarisZhao/awesome-face](https://github.com/polarisZhao/awesome-face) | awesome | 顔全般 | 915 | 2019-08 | 顔関連アルゴリズム・データセット・論文のキュレーション |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [MrNeRF/awesome-3D-gaussian-splatting](https://github.com/MrNeRF/awesome-3D-gaussian-splatting) | awesome | 3D Gaussian Splatting | 8658 | 2026-05 | 3DGSの論文・実装・ビューア・ツールを集めた包括リスト |
...
| 🟢 | [3D-Vision-World/awesome-NeRF-and-3DGS-SLAM](https://github.com/3D-Vision-World/awesome-NeRF-and-3DGS-SLAM) | paper-list | SLAM(NeRF/3DGS) | 2022 | 2026-05 | 暗黙表現・NeRF・3DGSを用いたSLAM論文集 |
| 🟢 | [weihaox/awesome-digital-human](https://github.com/weihaox/awesome-digital-human) | awesome | digital humans | 1948 | 2026-04 | 2D/3D/4D人体モデリング・アバター生成の総合集 |
| 🟢 | [Kedreamix/Awesome-Talking-Head-Synthesis](https://github.com/Kedreamix/Awesome-Talking-Head-Synthesis) | awesome | talking head | 1509 | 2026-05 | トーキングフェイス合成の広範な資源集 |
...
| 🟢 | [longxiang-ai/awesome-gaussians](https://github.com/longxiang-ai/awesome-gaussians) | paper-list | 3D Gaussian Splatting | 287 | 2026-06 | arXivから毎日自動更新される3DGS論文追跡 |
...
| 🟢 | [Bigger-and-Stronger/quad-meshing-survey](https://github.com/Bigger-and-Stronger/quad-meshing-survey) | survey | quad meshing | 37 | 2026-05 | クワッドメッシング関連の論文・コード・プロジェクト集 |
...
| 🟡 | [timzhang642/3D-Machine-Learning](https://github.com/timzhang642/3D-Machine-Learning) | awesome | 3D機械学習 | 10165 | 2024-07 | 3D機械学習(点群/メッシュ/ボクセル/SDF等)のリソースリポジトリ |
| 🟡 | [awesome-NeRF/awesome-NeRF](https://github.com/awesome-NeRF/awesome-NeRF) | awesome | NeRF | 6767 | 2025-01 | Neural Radiance Fields論文の定番キュレーションリスト |
...
| 🔴 | [openMVG/awesome_3DReconstruction_list](https://github.com/openMVG/awesome_3DReconstruction_list) | awesome | 3D reconstruction | 4408 | 2021-10 | 画像からの3D復元の古典的論文・資料集 |
| 🔴 | [Yochengliu/awesome-point-cloud-analysis](https://github.com/Yochengliu/awesome-point-cloud-analysis) | awesome | point cloud | 4215 | 2023-05 | 点群解析・処理に関する論文とデータセットのリスト |
...
| 🔴 | [luisdnsantos/awesome-computer-graphics](https://github.com/luisdnsantos/awesome-computer-graphics) | awesome | computer graphics(学習) | 1005 | 2021-07 | CG学習用の書籍・講座・資料集 |
...
| 🔴 | [tkuri/Awesome-BRDF](https://github.com/tkuri/Awesome-BRDF) | paper-list | material/BRDF | 29 | 2021-06 | BRDF表現に関する論文を表現方式別に整理 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [zhihongz/awesome-low-light-image-enhancement](https://github.com/zhihongz/awesome-low-light-image-enhancement) | awesome | 低照度強調 | 1822 | 2026-05 | 低照度画像強調のデータセット/手法/論文/評価指標を網羅(活発) |
...
| 🟢 | [MarkMoHR/Awesome-Image-Colorization](https://github.com/MarkMoHR/Awesome-Image-Colorization) | awesome | カラー化 | 1158 | 2026-04 | 深層学習ベースの画像/動画カラー化論文(2025-2026まで活発) |
...
| 🟢 | [MarkMoHR/Awesome-Sketch-Based-Applications](https://github.com/MarkMoHR/Awesome-Sketch-Based-Applications) | paper-list | スケッチ応用 | 707 | 2026-05 | スケッチベースのアプリケーション論文集 |
| 🟢 | [MarkMoHR/Awesome-Sketch-Synthesis](https://github.com/MarkMoHR/Awesome-Sketch-Synthesis) | paper-list | スケッチ合成 | 566 | 2026-05 | スケッチ合成(生成)に関する論文集 |
...
| 🟢 | [zhenglinpan/Awesome-Animation-Research](https://github.com/zhenglinpan/Awesome-Animation-Research) | paper-list | アニメーション研究 | 202 | 2026-04 | アニメーション(2D/カートゥーン等)の研究論文・データセットを集めたリスト |
| 🟢 | [IShengFang/TypographyResearchCollection](https://github.com/IShengFang/TypographyResearchCollection) | paper-list | タイポグラフィ/フォント生成 | 159 | 2025-08 | タイポグラフィ関連のCG/CV/ML研究収集(フォント生成・アニメーション含む) |
| 🟢 | [MarkMoHR/Awesome-2D-Animation](https://github.com/MarkMoHR/Awesome-2D-Animation) | paper-list | 2Dアニメーション | 38 | 2026-05 | 中割り(inbetweening)・2Dアニメーションのツール・データセット・論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [Hannibal046/Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) | awesome | LLM全般 | 26884 | 2025-07 | LLM論文・モデル・ツール・コースを網羅した最大級のリスト |
...
| 🟢 | [keon/awesome-nlp](https://github.com/keon/awesome-nlp) | awesome | NLP全般 | 18668 | 2026-05 | NLP全般のライブラリ・データ・チュートリアルを集めた定番リスト |
...
| 🟢 | [WangRongsheng/awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources) | awesome | LLMリソース総覧 | 8457 | 2026-05 | 多モーダル生成・Agent・補助コーディング・データ処理・訓練・推論等のLLM資料総まとめ |
| 🟢 | [ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | awesome | prompt engineering | 8085 | 2026-06 | 高評価GPTsのプロンプトと先端プロンプト工学論文のコレクション |
...
| 🟢 | [promptslab/Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) | awesome | prompt engineering | 5992 | 2026-05 | GPT/ChatGPT向けプロンプト技法の論文・ツールを集めたリスト |
| 🟢 | [xlite-dev/Awesome-LLM-Inference](https://github.com/xlite-dev/Awesome-LLM-Inference) | paper-list | efficient transformers/inference | 5262 | 2026-04 | FlashAttention・PagedAttention等の推論高速化論文集 |
| 🟢 | [eosphoros-ai/Awesome-Text2SQL](https://github.com/eosphoros-ai/Awesome-Text2SQL) | awesome | text-to-SQL | 3661 | 2026-01 | Text2SQL/Text2DSL等のチュートリアルとリソース集 |
| 🟢 | [atfortes/Awesome-LLM-Reasoning](https://github.com/atfortes/Awesome-LLM-Reasoning) | awesome | LLM推論 | 3623 | 2026-04 | CoTからo1/DeepSeek-R1までのLLM推論論文集(非常に活発) |
| 🟢 | [Meirtz/Awesome-Context-Engineering](https://github.com/Meirtz/Awesome-Context-Engineering) | survey | context engineering | 3162 | 2026-05 | プロンプト工学から本番AIシステムまでのコンテキスト工学サーベイ |
| 🟢 | [XiaoxinHe/Awesome-Graph-LLM](https://github.com/XiaoxinHe/Awesome-Graph-LLM) | awesome | graph + LLM | 2430 | 2025-11 | グラフ関連LLMのリソースを集めたキュレーション |
| 🟢 | [DEEP-PolyU/Awesome-GraphRAG](https://github.com/DEEP-PolyU/Awesome-GraphRAG) | awesome | RAG(graph-based) | 2416 | 2026-05 | グラフベースRAGのサーベイ・論文・ベンチマーク集 |
| 🟢 | [EgoAlpha/prompt-in-context-learning](https://github.com/EgoAlpha/prompt-in-context-learning) | paper-list | in-context learning | 2239 | 2026-05 | ICLとプロンプト工学の最新リソースを継続更新する論文リスト |
| 🟢 | [zjukg/KG-LLM-Papers](https://github.com/zjukg/KG-LLM-Papers) | paper-list | knowledge graph + LLM | 2195 | 2026-03 | 知識グラフとLLMを統合する論文リスト |
| 🟢 | [Xnhyacinth/Awesome-LLM-Long-Context-Modeling](https://github.com/Xnhyacinth/Awesome-LLM-Long-Context-Modeling) | paper-list | long context | 2107 | 2026-05 | 長文脈モデリング(効率的注意・KVキャッシュ・位置符号化等)の論文集 |
...
| 🟢 | [hemingkx/SpeculativeDecodingPapers](https://github.com/hemingkx/SpeculativeDecodingPapers) | survey | 投機的デコーディング | 1240 | 2026-05 | 投機的デコーディングの必読論文・ブログ集(サーベイ連動) |
| 🟢 | [zjunlp/KnowledgeEditingPapers](https://github.com/zjunlp/KnowledgeEditingPapers) | paper-list | knowledge editing | 1230 | 2025-07 | LLMの知識編集に関する論文リスト |
| 🟢 | [EdinburghNLP/awesome-hallucination-detection](https://github.com/EdinburghNLP/awesome-hallucination-detection) | paper-list | hallucination detection | 1096 | 2026-05 | LLMの幻覚検出論文をモデル別に整理したリスト |
...
| 🟢 | [Eclipsess/Awesome-Efficient-Reasoning-LLMs](https://github.com/Eclipsess/Awesome-Efficient-Reasoning-LLMs) | survey | 効率的推論 | 769 | 2026-02 | 「Stop Overthinking」効率的推論サーベイ(TMLR2025)の論文集 |
| 🟢 | [CSHaitao/Awesome-LLMs-as-Judges](https://github.com/CSHaitao/Awesome-LLMs-as-Judges) | survey | LLM-as-judge | 584 | 2025-07 | 「LLMs-as-Judges」評価手法サーベイの公式論文集 |
| 🟢 | [withinmiaov/A-Survey-on-Mixture-of-Experts-in-LLMs](https://github.com/withinmiaov/A-Survey-on-Mixture-of-Experts-in-LLMs) | survey | MoE | 502 | 2025-07 | TKDE採択「MoE in LLMs」サーベイの公式論文集 |
...
| 🟢 | [pprp/Awesome-LLM-Quantization](https://github.com/pprp/Awesome-LLM-Quantization) | awesome | quantization | 423 | 2026-04 | LLM量子化に特化した論文リスト |
| 🟢 | [MoE-Inf/awesome-moe-inference](https://github.com/MoE-Inf/awesome-moe-inference) | paper-list | MoE inference | 394 | 2026-03 | MoEモデルの推論最適化論文を集めたリスト |
| 🟢 | [ThreeSR/Awesome-Inference-Time-Scaling](https://github.com/ThreeSR/Awesome-Inference-Time-Scaling) | awesome | 推論時スケーリング | 385 | 2026-05 | 推論時/テスト時スケーリングの論文リスト(活発) |
...
| 📑 | [RUCAIBox/LLMSurvey](https://github.com/RUCAIBox/LLMSurvey) | survey | LLM全般 | 12165 | 2025-03 | 「A Survey of Large Language Models」公式リポジトリ |
...
| 🟡 | [huybery/Awesome-Code-LLM](https://github.com/huybery/Awesome-Code-LLM) | awesome | code generation | 1287 | 2024-12 | コード生成LLM研究の厳選キュレーションリスト |
...
| 🟡 | [RUCAIBox/awesome-llm-pretraining](https://github.com/RUCAIBox/awesome-llm-pretraining) | awesome | 事前学習データ | 376 | 2025-04 | LLM事前学習のデータ・フレームワーク・手法リソース集 |
...
| 🔴 | [thunlp/PromptPapers](https://github.com/thunlp/PromptPapers) | paper-list | プロンプトチューニング | 4313 | 2023-07 | 事前学習モデルのプロンプトベースチューニングの必読論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [showlab/Awesome-Video-Diffusion](https://github.com/showlab/Awesome-Video-Diffusion) | awesome | 動画生成 | 5675 | 2026-05 | 動画生成・編集の拡散モデルを集めた定番リスト |
...
| 🟢 | [ChenHsing/Awesome-Video-Diffusion-Models](https://github.com/ChenHsing/Awesome-Video-Diffusion-Models) | survey | 動画生成 | 2292 | 2026-04 | Video Diffusion Modelのサーベイ(CSUR) |
...
| 🟢 | [harlanhong/awesome-talking-head-generation](https://github.com/harlanhong/awesome-talking-head-generation) | paper-list | talking head | 1911 | 2026-04 | トーキングヘッド生成の論文リスト |
...
| 🟢 | [ChaofanTao/Autoregressive-Models-in-Vision-Survey](https://github.com/ChaofanTao/Autoregressive-Models-in-Vision-Survey) | survey | 自己回帰生成 | 797 | 2026-05 | ビジョンの自己回帰モデルサーベイ(TMLR 2025) |
...
| 🟢 | [gracezhao1997/Awesome-Video-World-Models-with-AR-Diffusion](https://github.com/gracezhao1997/Awesome-Video-World-Models-with-AR-Diffusion) | awesome | 世界モデル | 568 | 2026-05 | AR+拡散の動画世界モデル(アルゴリズム/応用/基盤) |
...
| 🟢 | [ziqihuangg/Awesome-From-Video-Generation-to-World-Model](https://github.com/ziqihuangg/Awesome-From-Video-Generation-to-World-Model) | paper-list | 世界モデル | 486 | 2026-03 | 動画生成から世界モデルへの流れを整理 |
...
| 🟢 | [ziqihuangg/Awesome-Evaluation-of-Visual-Generation](https://github.com/ziqihuangg/Awesome-Evaluation-of-Visual-Generation) | paper-list | 生成評価 | 446 | 2026-05 | 視覚生成の評価指標/モデル/システム集 |
...
| 🟢 | [Zheng-Chong/Awesome-Try-On-Models](https://github.com/Zheng-Chong/Awesome-Try-On-Models) | paper-list | 仮想試着 | 416 | 2026-05 | 仮想試着モデル(2025含む)を整理 |
| 🟢 | [ant-research/Awesome-AIGC-Image-Video-Detection](https://github.com/ant-research/Awesome-AIGC-Image-Video-Detection) | paper-list | AI生成検出 | 393 | 2026-05 | AI生成画像/動画検出の最新研究集 |
| 🟢 | [AlonzoLeeeooo/awesome-image-inpainting-studies](https://github.com/AlonzoLeeeooo/awesome-image-inpainting-studies) | awesome | inpainting | 386 | 2026-02 | 画像インペインティング研究のコレクション |
...
| 🟡 | [diff-usion/Awesome-Diffusion-Models](https://github.com/diff-usion/Awesome-Diffusion-Models) | awesome | diffusion総合 | 12334 | 2024-08 | Diffusion Modelの論文・資源を網羅した最大級のリスト |
...
| 📚 | [hindupuravinash/the-gan-zoo](https://github.com/hindupuravinash/the-gan-zoo) | paper-list | GAN | 14701 | 2023-10 | 命名された全GANを一覧化した古典的リスト |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [PicoTrex/Awesome-Nano-Banana-images](https://github.com/PicoTrex/Awesome-Nano-Banana-images) | model | Nano Banana | 22920 | 2025-12 | Gemini系Nano Bananaの生成例・プロンプト集(データセット公開) |
| 🟢 | [EvoLinkAI/awesome-gpt-image-2-API-and-Prompts](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts) | model | GPT-Image-2 | 15816 | 2026-05 | GPT-Image-2のAPIとプロンプト・作例集 |
| 🟢 | [YouMind-OpenLab/awesome-nano-banana-pro-prompts](https://github.com/YouMind-OpenLab/awesome-nano-banana-pro-prompts) | model | Nano Banana Pro | 12331 | 2026-06 | 世界最大級のNano Banana Proプロンプト集10,000+/16言語(毎日更新) |
| 🟢 | [ZeroLu/awesome-nanobanana-pro](https://github.com/ZeroLu/awesome-nanobanana-pro) | model | Nano Banana | 10040 | 2026-05 | Nano Banana Pro(Nano Banana 2)のプロンプト・作例集 |
...
| 🟢 | [YouMind-OpenLab/awesome-seedance-2-prompts](https://github.com/YouMind-OpenLab/awesome-seedance-2-prompts) | model | Seedance 2.0 | 1269 | 2026-05 | Seedance 2.0動画生成プロンプト2000+(毎日更新) |
...
| 🟢 | [songguoxs/awesome-video-prompts](https://github.com/songguoxs/awesome-video-prompts) | model | Veo3/Kling/Hailuo | 518 | 2025-10 | Veo3/Kling/Hailuo向け動画プロンプト集 |
...
| 🟢 | [geekjourneyx/awesome-ai-video-prompts](https://github.com/geekjourneyx/awesome-ai-video-prompts) | model | Veo/Sora/Kling/Runway | 57 | 2026-01 | 複数動画モデル横断のプロンプト/技法集 |
| 🟢 | [YouMind-OpenLab/awesome-grok-imagine-prompts](https://github.com/YouMind-OpenLab/awesome-grok-imagine-prompts) | model | Grok Imagine | 14 | 2026-05 | Grok Imagine(xAI)動画生成プロンプト集 |
...
| 🟡 | [jamez-bondos/awesome-gpt4o-images](https://github.com/jamez-bondos/awesome-gpt4o-images) | model | GPT-4o/gpt-image-1 | 8061 | 2025-05 | GPT-4o・gpt-image-1の画像・プロンプト作例集 |
| 🟡 | [ai-boost/Awesome-GPTs](https://github.com/ai-boost/Awesome-GPTs) | model | GPT Store | 3390 | 2024-11 | GPT Store掲載のGPTを集めたキュレーション |
| 🟡 | [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | model | GPT-4o画像 | 564 | 2025-05 | GPT-4o画像生成のプロンプト辞典 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) | awesome | LLMアプリ/RAG/Agent | 112400 | 2026-06 | 実行可能なLLMアプリ/RAG/エージェントのコレクション |
| 🟢 | [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | awesome | MCP | 88256 | 2026-05 | 最大手のMCP(Model Context Protocol)サーバーコレクション |
| 🟢 | [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | awesome | Claude Skills | 62710 | 2026-05 | Claude Skill/ツールのキュレーション |
| 🟢 | [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | awesome | Claude Code | 45344 | 2026-04 | Claude Code向けskill/hook/slash-command/プラグイン集 |
| 🟢 | [deepseek-ai/awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration) | model | DeepSeek | 37688 | 2026-02 | DeepSeek APIを各種ソフトに統合する公式キュレーション |
| 🟢 | [bharathgs/Awesome-pytorch-list](https://github.com/bharathgs/Awesome-pytorch-list) | awesome | PyTorchエコシステム | 16512 | 2026-02 | PyTorch関連のモデル・実装・ライブラリを網羅した大規模リスト |
| 🟢 | [steven2358/awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) | awesome | 生成AIプロジェクト/サービス | 12091 | 2026-05 | 現代の生成AIプロジェクト・サービスを厳選したリスト |
| 🟢 | [kyrolabs/awesome-langchain](https://github.com/kyrolabs/awesome-langchain) | awesome | LangChain | 9386 | 2026-04 | LangChainフレームワークのツール・プロジェクトのリスト |
| 🟢 | [ai-collection/ai-collection](https://github.com/ai-collection/ai-collection) | awesome | 生成AIアプリ | 8963 | 2026-06 | 生成AIアプリケーションを集めたランドスケープ |
| 🟢 | [sindresorhus/awesome-chatgpt](https://github.com/sindresorhus/awesome-chatgpt) | awesome | ChatGPT | 6274 | 2026-02 | ChatGPT向けawesomeリスト(sindresorhus系列) |
| 🟢 | [ikaijua/Awesome-AITools](https://github.com/ikaijua/Awesome-AITools) | awesome | AIツール | 5975 | 2026-05 | AI関連の実用ツールを収集したコレクション(中英併記) |
| 🟢 | [tensorchord/Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) | awesome | LLMOps | 5814 | 2026-05 | LLM開発・運用向けツール(学習/サービング/監視)の厳選リスト |
| 🟢 | [appcypher/awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers) | awesome | MCP | 5573 | 2026-05 | MCPサーバーのキュレーション |
| 🟢 | [mahseema/awesome-ai-tools](https://github.com/mahseema/awesome-ai-tools) | awesome | AIツール | 5367 | 2025-12 | AIのトップツールを厳選したリスト |
| 🟢 | [alvinreal/awesome-opensource-ai](https://github.com/alvinreal/awesome-opensource-ai) | awesome | オープンソースAI | 3716 | 2026-05 | 真にオープンソースなAIプロジェクト・モデル・ツール・基盤の厳選リスト |
| 🟢 | [eon01/awesome-chatgpt](https://github.com/eon01/awesome-chatgpt) | awesome | ChatGPT | 2370 | 2026-03 | ChatGPTのライブラリ/SDK/APIキュレーション |
| 🟢 | [webfuse-com/awesome-claude](https://github.com/webfuse-com/awesome-claude) | awesome | Claude | 1490 | 2026-05 | Anthropic Claude全般のキュレーションリスト |
| 🟢 | [Danielskry/Awesome-RAG](https://github.com/Danielskry/Awesome-RAG) | awesome | RAGアプリ | 1212 | 2026-05 | 生成AIにおけるRAGアプリのawesomeリスト |
...
| 🟢 | [ComfyUI-Workflow/awesome-comfyui](https://github.com/ComfyUI-Workflow/awesome-comfyui) | awesome | ComfyUI | 698 | 2025-07 | ComfyUIカスタムノードの大規模コレクション |
| 🟢 | [Piebald-AI/awesome-gemini-cli](https://github.com/Piebald-AI/awesome-gemini-cli) | awesome | Gemini CLI | 458 | 2026-05 | Gemini CLI向けツール/拡張/リソース集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [LantaoYu/MARL-Papers](https://github.com/LantaoYu/MARL-Papers) | paper-list | MARL | 4840 | 2026-02 | マルチエージェントRLの研究・サーベイ論文リスト(定番) |
| 🟢 | [GT-RIPL/Awesome-LLM-Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) | paper-list | RL for robotics/LLM | 4383 | 2026-04 | ロボティクス/RLへのLLM・マルチモーダル活用論文集 |
| 🟢 | [opendilab/awesome-RLHF](https://github.com/opendilab/awesome-RLHF) | paper-list | RLHF | 4374 | 2026-05 | 人間フィードバックによるRLの論文・資源を継続更新 |
...
| 🟢 | [leofan90/Awesome-World-Models](https://github.com/leofan90/Awesome-World-Models) | paper-list | world models | 1727 | 2026-06 | ワールドモデル(動画生成・Embodied AI・自動運転)の論文網羅 |
| 🟢 | [opendilab/awesome-diffusion-model-in-rl](https://github.com/opendilab/awesome-diffusion-model-in-rl) | awesome | RL拡散モデル | 1605 | 2026-05 | 強化学習における拡散モデルの資源を継続更新するリスト |
| 🟢 | [opendilab/awesome-model-based-RL](https://github.com/opendilab/awesome-model-based-RL) | paper-list | model-based RL | 1354 | 2026-05 | モデルベースRLの論文を継続更新で収集 |
...
| 🟢 | [chauncygu/Safe-Reinforcement-Learning-Baselines](https://github.com/chauncygu/Safe-Reinforcement-Learning-Baselines) | paper-list | safe RL | 794 | 2026-03 | Safe RLのベースライン・論文を集めたリポジトリ |
| 🟢 | [tsinghua-fib-lab/World-Model](https://github.com/tsinghua-fib-lab/World-Model) | survey | 世界モデル(包括) | 727 | 2025-11 | 世界モデルの包括的サーベイ(ACM CSUR 2025採録) |
...
| 🟢 | [opendilab/awesome-multi-modal-reinforcement-learning](https://github.com/opendilab/awesome-multi-modal-reinforcement-learning) | paper-list | multi-modal RL | 607 | 2026-05 | マルチモーダルRL資源を継続更新 |
| 🟢 | [yingchengyang/Reinforcement-Learning-Papers](https://github.com/yingchengyang/Reinforcement-Learning-Papers) | paper-list | 総合(トップ会議) | 571 | 2026-02 | ICLR/ICML/NeurIPSの古典+最新論文を年別に整理 |
...
| 🟢 | [opendilab/awesome-RLVR](https://github.com/opendilab/awesome-RLVR) | paper-list | RLVR | 166 | 2026-05 | 検証可能報酬によるRL(RLVR)の論文を継続更新 |
...
| 🟢 | [operator22th/awesome-world-models-for-robots](https://github.com/operator22th/awesome-world-models-for-robots) | paper-list | world models/robotics | 136 | 2026-03 | ロボティクス向けワールドモデル論文集 |
...
| 🟡 | [datamllab/awesome-game-ai](https://github.com/datamllab/awesome-game-ai) | awesome | game AI/MARL | 964 | 2024-06 | マルチエージェント学習中心のゲームAI資源集 |
...
| 🔴 | [aikorea/awesome-rl](https://github.com/aikorea/awesome-rl) | awesome | 総合 | 9774 | 2023-05 | RL全般のコード・講義・論文・環境を集めた定番キュレーション |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [BradyFU/Awesome-Multimodal-Large-Language-Models](https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models) | survey | MLLM | 17846 | 2026-05 | MLLM分野の最有名サーベイ。アーキテクチャ・学習・評価を網羅追跡 |
| 🟢 | [yunlong10/Awesome-LLMs-for-Video-Understanding](https://github.com/yunlong10/Awesome-LLMs-for-Video-Understanding) | paper-list | 動画理解LLM | 3191 | 2026-03 | 動画理解向けVid-LLMの最新論文・コード・データセット |
| 🟢 | [jingyi0000/VLM_survey](https://github.com/jingyi0000/VLM_survey) | survey | VLM | 3124 | 2025-10 | 視覚タスク向けVision-Languageモデルの系統的レビュー |
| 🟢 | [ActiveVisionLab/Awesome-LLM-3D](https://github.com/ActiveVisionLab/Awesome-LLM-3D) | awesome | 3D-LLM | 2212 | 2026-04 | 3D世界における多モーダルLLM資源の網羅リスト |
| 🟢 | [AIDC-AI/Awesome-Unified-Multimodal-Models](https://github.com/AIDC-AI/Awesome-Unified-Multimodal-Models) | survey | 統合マルチモーダル | 1269 | 2026-03 | 理解と生成を統合する多モーダルモデルの網羅集(活発) |
...
| 🟢 | [showlab/Awesome-MLLM-Hallucination](https://github.com/showlab/Awesome-MLLM-Hallucination) | awesome | MLLM幻覚 | 1021 | 2025-09 | マルチモーダルLLMの幻覚(hallucination)に関する資源の厳選リスト |
...
| 🟢 | [mll-lab-nu/Awesome-Spatial-Intelligence-in-VLM](https://github.com/mll-lab-nu/Awesome-Spatial-Intelligence-in-VLM) | paper-list | 空間知能(VLM) | 748 | 2026-01 | VLMの空間推論に関する論文・ベンチマーク約200本(非常に活発) |
...
| 🟢 | [ga642381/speech-trident](https://github.com/ga642381/speech-trident) | paper-list | 音声LLM | 1230 | 2026-04 | 音声/オーディオLLM・表現学習・codecモデルの論文集 |
| 🟢 | [BinWang28/audio-ai-hub](https://github.com/BinWang28/audio-ai-hub) | awesome | 音声LLM | 925 | 2026-05 | オーディオ大規模言語モデルの論文・リソース集 |
| 🟢 | [EmulationAI/awesome-large-audio-models](https://github.com/EmulationAI/awesome-large-audio-models) | awesome | 音声LLM | 730 | 2026-05 | LLMのAudio AI応用に関するリソース集 |
...
| 🟢 | [wildminder/awesome-ai-voice](https://github.com/wildminder/awesome-ai-voice) | model | 音声生成 | 338 | 2026-04 | OSSのTTS・音声クローン・音楽生成モデル集 |
...
| 🟡 | [soham97/awesome-sound_event_detection](https://github.com/soham97/awesome-sound_event_detection) | paper-list | 音響イベント検出 | 196 | 2024-08 | Sound AI(音響イベント検出、音声キャプショニング等)の研究リーディングリスト |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [jonyzhang2023/awesome-embodied-vla-va-vln](https://github.com/jonyzhang2023/awesome-embodied-vla-va-vln) | paper-list | VLA/VLN | 3195 | 2026-05 | embodied AIのVLA・VLN・マルチモーダル学習の最先端研究集 |
| 🟢 | [jslee02/awesome-robotics-libraries](https://github.com/jslee02/awesome-robotics-libraries) | awesome | ロボティクスライブラリ | 2938 | 2026-05 | ロボティクスのライブラリ・ソフトウェアを厳選したリスト |
| 🟢 | [YanjieZe/awesome-humanoid-robot-learning](https://github.com/YanjieZe/awesome-humanoid-robot-learning) | paper-list | ヒューマノイド | 2379 | 2026-05 | ヒューマノイドロボット学習の論文リスト |
| 🟢 | [HCPLab-SYSU/Embodied_AI_Paper_List](https://github.com/HCPLab-SYSU/Embodied_AI_Paper_List) | survey | 身体性AI | 2070 | 2026-05 | 身体性AIの知覚・相互作用・エージェント・sim-to-realを網羅(IEEE/ASME ToM 2025) |
| 🟢 | [zchoi/Awesome-Embodied-Robotics-and-Agent](https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent) | awesome | embodied AI | 1806 | 2026-05 | LLMを用いたembodied AI/ロボット研究のキュレーション |
...
| 🟢 | [BaiShuanghao/Awesome-Robotics-Manipulation](https://github.com/BaiShuanghao/Awesome-Robotics-Manipulation) | paper-list | manipulation | 991 | 2026-05 | ロボットマニピュレーションの論文・コード集 |
| 🟢 | [DravenALG/awesome-vla-wam](https://github.com/DravenALG/awesome-vla-wam) | awesome | VLA/WAM | 658 | 2026-05 | VLAとWorld Action Model(WAM)研究のキュレーション |
| 🟢 | [Songwxuan/Embodied-AI-Paper-TopConf](https://github.com/Songwxuan/Embodied-AI-Paper-TopConf) | paper-list | 会議論文(Embodied AI) | 658 | 2026-05 | トップ会議採択のEmbodied AI論文を継続収集(2026会議まで反映、活発) |
| 🟢 | [yueen-ma/Awesome-VLA](https://github.com/yueen-ma/Awesome-VLA) | survey | VLA | 580 | 2026-02 | embodied AI向けVLAモデルのサーベイ論文付きリスト |
...
| 🟢 | [wadeKeith/Awesome-Embodied-AI](https://github.com/wadeKeith/Awesome-Embodied-AI) | awesome | embodied AI | 211 | 2026-04 | embodied AIのサーベイ・VLA・データセット・シミュレータ等を網羅 |
| 🟢 | [KwanWaiPang/Awesome-VLN](https://github.com/KwanWaiPang/Awesome-VLN) | survey | 視覚言語ナビゲーション | 140 | 2026-05 | 視覚言語ナビゲーション(VLN)のサーベイ用論文集 |
...
| 🔴 | [gaiyi7788/awesome-legged-locomotion-learning](https://github.com/gaiyi7788/awesome-legged-locomotion-learning) | awesome | 脚式ロコモーション | 478 | 2023-07 | 脚式ロコモーション学習のリソース集 |

### 🕸️ グラフ学習(GNN) / 知識グラフ  (35件)

| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [safe-graph/graph-fraud-detection-papers](https://github.com/safe-graph/graph-fraud-detection-papers) | paper-list | グラフ不正検知 | 1841 | 2026-05 | グラフ/Transformerベースの不正・異常・外れ値検知論文集 |
| 🟢 | [LIANGKE23/Awesome-Knowledge-Graph-Reasoning](https://github.com/LIANGKE23/Awesome-Knowledge-Graph-Reasoning) | paper-list | KG推論 | 1451 | 2025-11 | 知識グラフ推論の論文・コード・データセット集 |
| 🟢 | [yyysjz1997/Awesome-TimeSeries-SpatioTemporal-Diffusion-Model](https://github.com/yyysjz1997/Awesome-TimeSeries-SpatioTemporal-Diffusion-Model) | survey | 時空間拡散モデル | 988 | 2026-02 | 時系列・時空間データ向け拡散モデルのサーベイ＆論文集(活発) |
...
| 🟡 | [thunlp/GNNPapers](https://github.com/thunlp/GNNPapers) | paper-list | GNN必読論文 | 16785 | 2023-12 | グラフニューラルネットワーク(GNN)の必読論文集(定番) |
...
| 🟡 | [ChandlerBang/awesome-self-supervised-gnn](https://github.com/ChandlerBang/awesome-self-supervised-gnn) | paper-list | 自己教師ありGNN | 1726 | 2024-02 | GNNの事前学習・自己教師あり学習の論文集 |
...
| 🔴 | [benedekrozemberczki/awesome-graph-classification](https://github.com/benedekrozemberczki/awesome-graph-classification) | paper-list | グラフ分類/埋め込み | 4803 | 2023-03 | グラフ埋め込み・分類・表現学習の重要論文集(実装付) |
...
| 🔴 | [shaoxiongji/knowledge-graphs](https://github.com/shaoxiongji/knowledge-graphs) | paper-list | knowledge graph | 1789 | 2022-10 | 知識グラフ研究(埋め込み・補完・時系列KG・応用)の論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [hongleizhang/RSPapers](https://github.com/hongleizhang/RSPapers) | awesome | 推薦必読論文 | 6497 | 2026-03 | 推薦システム必読論文を17カテゴリで整理、毎週更新(LLM/Agentic RS等も追加) |
| 🟢 | [guyulongcs/Awesome-Deep-Learning-Papers-for-Search-Recommendation-Advertising](https://github.com/guyulongcs/Awesome-Deep-Learning-Papers-for-Search-Recommendation-Advertising) | paper-list | 検索・推薦・広告 | 2509 | 2026-04 | 検索・推薦・広告向け深層学習論文集 |
| 🟢 | [CHIANGEL/Awesome-LLM-for-RecSys](https://github.com/CHIANGEL/Awesome-LLM-for-RecSys) | survey | LLM推薦 | 1538 | 2026-01 | LLM関連の推薦システム論文集(TOIS採録サーベイ付き) |
...
| 🟢 | [TongjiFinLab/awesome-time-series-forecasting](https://github.com/TongjiFinLab/awesome-time-series-forecasting) | paper-list | 時系列予測 | 264 | 2026-04 | 時系列予測の論文・コード集 |
...
| 🟡 | [rob-med/awesome-TS-anomaly-detection](https://github.com/rob-med/awesome-TS-anomaly-detection) | awesome | 時系列異常検知 | 3170 | 2024-10 | 時系列データの異常検知ツール・データセットのリスト |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [WooooDyy/LLM-Agent-Paper-List](https://github.com/WooooDyy/LLM-Agent-Paper-List) | survey | LLMエージェント | 8136 | 2025-09 | 86ページのサーベイ「The Rise and Potential of LLM Based Agents」の論文リスト |
| 🟢 | [zjunlp/LLMAgentPapers](https://github.com/zjunlp/LLMAgentPapers) | paper-list | LLMエージェント | 3022 | 2026-04 | LLMエージェントの必読論文集 |
| 🟢 | [luo-junyu/Awesome-Agent-Papers](https://github.com/luo-junyu/Awesome-Agent-Papers) | survey | LLMエージェント | 2721 | 2025-11 | LLMエージェントの手法・応用・課題サーベイの論文集 |
...
| 🟢 | [kyegomez/awesome-multi-agent-papers](https://github.com/kyegomez/awesome-multi-agent-papers) | awesome | マルチエージェント | 1512 | 2026-05 | マルチエージェント論文のキュレーション集(Swarms team) |
...
| 🟢 | [Jenqyang/Awesome-AI-Agents](https://github.com/Jenqyang/Awesome-AI-Agents) | awesome | AIエージェント | 1140 | 2026-05 | LLM駆動の自律エージェントコレクション |
| 🟢 | [VoltAgent/awesome-ai-agent-papers](https://github.com/VoltAgent/awesome-ai-agent-papers) | paper-list | AIエージェント | 986 | 2026-05 | AIエージェント研究論文集(工学・メモリ・評価・ワークフロー) |
| 🟢 | [OSU-NLP-Group/GUI-Agents-Paper-List](https://github.com/OSU-NLP-Group/GUI-Agents-Paper-List) | paper-list | GUIエージェント | 804 | 2026-05 | GUIエージェント論文の厳選リスト |
| 🟢 | [ranpox/awesome-computer-use](https://github.com/ranpox/awesome-computer-use) | awesome | computer use | 558 | 2026-04 | Computer-use GUIエージェントの動画・ブログ・論文・プロジェクト集 |
| 🟢 | [TsinghuaC3I/Awesome-Memory-for-Agents](https://github.com/TsinghuaC3I/Awesome-Memory-for-Agents) | paper-list | エージェント記憶 | 527 | 2026-05 | 言語エージェントの記憶(ユーザプロファイル・対話履歴)に関する論文集 |
...
| 🟢 | [DEEP-PolyU/Awesome-GraphMemory](https://github.com/DEEP-PolyU/Awesome-GraphMemory) | survey | グラフエージェント記憶 | 279 | 2026-04 | グラフベースのエージェント記憶のサーベイ・論文・ベンチマーク集 |
| 🟡 | [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) | awesome | AI自律エージェント | 28094 | 2025-02 | AI自律エージェント(プロジェクト/フレームワーク)の大規模リスト |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [AI-in-Health/MedLLMsPracticalGuide](https://github.com/AI-in-Health/MedLLMsPracticalGuide) | survey | 医療LLM | 2016 | 2025-09 | 医療LLM実践ガイド(Nature Reviews Bioengineering掲載) |
| 🟢 | [ai-boost/awesome-ai-for-science](https://github.com/ai-boost/awesome-ai-for-science) | awesome | AI for Science | 1609 | 2026-06 | 物理・化学・生物・材料など科学的発見を加速するAIツール・論文集 |
...
| 🟢 | [OmicsML/awesome-foundation-model-single-cell-papers](https://github.com/OmicsML/awesome-foundation-model-single-cell-papers) | paper-list | シングルセル基盤モデル | 452 | 2026-01 | シングルセル基盤モデルに特化した論文リスト |
| 🟢 | [mk-runner/Awesome-Radiology-Report-Generation](https://github.com/mk-runner/Awesome-Radiology-Report-Generation) | paper-list | 放射線レポート生成 | 437 | 2026-06 | 放射線レポート生成の論文・データセット・ツール集(非常に活発) |
...
| 🟢 | [ambicuity/Awesome-MICCAI-2026](https://github.com/ambicuity/Awesome-MICCAI-2026) | paper-list | 会議論文(MICCAI) | 23 | 2026-05 | MICCAI 2026論文をarXivから自動収集しbotが毎日更新、分野別分類 |
...
| 🟡 | [OmicsML/awesome-deep-learning-single-cell-papers](https://github.com/OmicsML/awesome-deep-learning-single-cell-papers) | paper-list | シングルセル | 857 | 2025-04 | シングルセル解析×深層学習の最新論文を30以上のタスク別に整理 |
...
| 🟢 | [georgezouq/awesome-ai-in-finance](https://github.com/georgezouq/awesome-ai-in-finance) | awesome | AI for Finance | 6002 | 2026-05 | 金融市場のLLM・深層学習戦略・ツールの定番リスト |
| 🟢 | [codefuse-ai/Awesome-Code-LLM](https://github.com/codefuse-ai/Awesome-Code-LLM) | paper-list | AI for Code | 3363 | 2026-05 | コード向け言語モデル研究とデータセットの網羅的キュレーション |
| 🟢 | [wenhwu/awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) | awesome | リモートセンシング変化検出 | 2237 | 2026-04 | RS変化検出のデータセット・手法・サーベイ集 |
| 🟢 | [Jack-bo1220/Awesome-Remote-Sensing-Foundation-Models](https://github.com/Jack-bo1220/Awesome-Remote-Sensing-Foundation-Models) | paper-list | リモートセンシング基盤モデル | 1835 | 2026-05 | RSFMの論文・データセット・ベンチ・事前学習重みを網羅(活発) |
| 🟢 | [brycejohnston/awesome-agriculture](https://github.com/brycejohnston/awesome-agriculture) | awesome | 農業AI | 1775 | 2026-01 | 農業・農場・園芸向けOSS技術(ML・GIS・リモセン・ロボティクス含む)の定番リスト |
...
| 🟢 | [JuDFTteam/best-of-atomistic-machine-learning](https://github.com/JuDFTteam/best-of-atomistic-machine-learning) | awesome | 原子論的ML/材料 | 691 | 2026-05 | 原子論的機械学習プロジェクト約510件をスコア付きランキング(活発) |
...
| 🟢 | [maastrichtlawtech/awesome-legal-nlp](https://github.com/maastrichtlawtech/awesome-legal-nlp) | awesome | 法務NLP | 326 | 2025-10 | 判決予測・契約分類・判例検索・法務QA等のLegalNLPリソース集 |
| 🟢 | [GeminiLight/awesome-ai-llm4education](https://github.com/GeminiLight/awesome-ai-llm4education) | paper-list | 教育AI | 187 | 2026-04 | トップ会議・ジャーナルの教育向けAI/LLM論文を収集 |
| 🟢 | [AI-in-Transportation-Lab/awesome-pinns](https://github.com/AI-in-Transportation-Lab/awesome-pinns) | awesome | PINN/SciML | 110 | 2026-06 | PINN/物理情報機械学習のライブラリ・論文・チュートリアル厳選集 |
| 🟢 | [Event-AHU/PINN_Paper_List](https://github.com/Event-AHU/PINN_Paper_List) | paper-list | PINN | 78 | 2026-04 | 物理情報ニューラルネットワーク(PINN)の論文リスト |
...
| 🟡 | [grananqvist/Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) | awesome | クオンツ取引 | 3673 | 2025-05 | 機械学習に重点を置いたクオンツ/アルゴリズム取引のリソース集 |
...
| 🟡 | [Thinklab-SJTU/awesome-ai4eda](https://github.com/Thinklab-SJTU/awesome-ai4eda) | paper-list | AI for EDA | 209 | 2023-12 | 電子設計自動化(EDA・チップ設計)へのAI応用論文集 |
...
| 🔴 | [src-d/awesome-machine-learning-on-source-code](https://github.com/src-d/awesome-machine-learning-on-source-code) | awesome | MLonCode | 6586 | 2020-12 | ソースコードに適用した機械学習(MLonCode)の論文・リンク集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [OpenDriveLab/Birds-eye-view-Perception](https://github.com/OpenDriveLab/Birds-eye-view-Perception) | survey | BEV知覚 | 1375 | 2025-07 | BEV知覚研究とクックブック(IEEE T-PAMI 2023) |
...
| 🟡 | [jiachenli94/Awesome-Interaction-Aware-Trajectory-Prediction](https://github.com/jiachenli94/Awesome-Interaction-Aware-Trajectory-Prediction) | paper-list | 軌道予測 | 1683 | 2024-09 | 相互作用を考慮した軌道予測の最先端研究資料集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [jphall663/awesome-machine-learning-interpretability](https://github.com/jphall663/awesome-machine-learning-interpretability) | awesome | 解釈性 | 4038 | 2026-05 | 責任あるML・解釈性の総合リソースリスト |
...
| 🟢 | [wangyongjie-ntu/Awesome-explainable-AI](https://github.com/wangyongjie-ntu/Awesome-explainable-AI) | paper-list | XAI | 1643 | 2026-03 | 説明可能AI/MLの研究資料集 |
...
| 🟢 | [yueliu1999/Awesome-Jailbreak-on-LLMs](https://github.com/yueliu1999/Awesome-Jailbreak-on-LLMs) | paper-list | LLMジェイルブレイク | 1394 | 2026-05 | LLMジェイルブレイク手法の論文・コード・データセット・評価集(非常に活発) |
...
| 🟢 | [chrisliu298/awesome-llm-unlearning](https://github.com/chrisliu298/awesome-llm-unlearning) | paper-list | LLMアンラーニング | 594 | 2026-05 | LLMの機械unラーニング論文・サーベイ・ベンチマーク集 |
...
| 🟢 | [and-mill/Awesome-GenAI-Watermarking](https://github.com/and-mill/Awesome-GenAI-Watermarking) | awesome | 生成AI電子透かし | 141 | 2026-05 | 生成AIモデル向け電子透かし手法を画像・音声・テキスト別に整理(活発) |
| 🟢 | [AI-in-Transportation-Lab/awesome-mechanistic-interpretability](https://github.com/AI-in-Transportation-Lab/awesome-mechanistic-interpretability) | awesome | 機械的解釈性 | 98 | 2026-06 | ニューラルネットを理解可能な計算要素へ逆解析する機械的解釈性のリソース集 |
...
| 🟡 | [jivoi/awesome-ml-for-cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) | awesome | サイバーセキュリティML | 8804 | 2024-08 | マルウェア・侵入検知等にMLを使うツール・論文・教材の定番リスト |
...
| 🟢 | [ValueByte-AI/Awesome-LLM-in-Social-Science](https://github.com/ValueByte-AI/Awesome-LLM-in-Social-Science) | paper-list | LLM×社会科学 | 623 | 2026-02 | 社会科学にLLMを応用する論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [likedan/Awesome-CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) | model | CoreMLモデル | 7009 | 2025-06 | iOS向けCore MLモデルの最大級のリスト |
| 🟢 | [Efficient-ML/Awesome-Model-Quantization](https://github.com/Efficient-ML/Awesome-Model-Quantization) | paper-list | 量子化 | 2385 | 2026-05 | モデル量子化の論文・コード・ドキュメントのリスト |
...
| 🟢 | [HuangOwen/Awesome-LLM-Compression](https://github.com/HuangOwen/Awesome-LLM-Compression) | awesome | LLM圧縮 | 1839 | 2026-02 | 量子化・枝刈り・蒸留などLLM圧縮の論文とツール集 |
| 🟢 | [gigwegbe/tinyml-papers-and-projects](https://github.com/gigwegbe/tinyml-papers-and-projects) | paper-list | TinyML | 1012 | 2025-12 | TinyMLの論文・プロジェクト集(活発に更新) |
...
| 🟢 | [jeho-lee/Awesome-On-Device-AI-Systems](https://github.com/jeho-lee/Awesome-On-Device-AI-Systems) | awesome | オンデバイスAIシステム | 157 | 2026-05 | オンデバイスAIシステム(推論エンジン/ベンチ/論文)、活発 |
...
| 📑 | [Tebmer/Awesome-Knowledge-Distillation-of-LLMs](https://github.com/Tebmer/Awesome-Knowledge-Distillation-of-LLMs) | survey | LLM知識蒸留 | 1282 | 2025-03 | LLMの知識蒸留サーベイ連動の論文集 |
...
| 🟢 | [gnipping/Awesome-ML-SP-Papers](https://github.com/gnipping/Awesome-ML-SP-Papers) | paper-list | MLセキュリティ | 348 | 2025-11 | セキュリティトップ4会議のML Security & Privacy論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [xialeiliu/Awesome-Incremental-Learning](https://github.com/xialeiliu/Awesome-Incremental-Learning) | paper-list | 継続学習 | 4470 | 2026-05 | 増分学習・継続学習・破滅的忘却の主要会議論文集 |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [HuaizhengZhang/AI-Infra-from-Zero-to-Hero](https://github.com/HuaizhengZhang/AI-Infra-from-Zero-to-Hero) | awesome | MLシステム | 4057 | 2025-07 | AIシステム論文と産業実践(OSDI/NSDI/MLSys等、LLM・GenAI含む)を集めた定番 |
| 🟢 | [wasiahmad/Awesome-LLM-Synthetic-Data](https://github.com/wasiahmad/Awesome-LLM-Synthetic-Data) | paper-list | 合成データ | 1538 | 2025-06 | LLMによる合成データ生成のリーディングリスト(活発) |
...
| 🟢 | [byungsoo-oh/ml-systems-papers](https://github.com/byungsoo-oh/ml-systems-papers) | paper-list | MLシステム | 569 | 2026-02 | MLシステム分野の論文を体系的に集めたコレクション |
...
| 🟡 | [currentslab/awesome-vector-search](https://github.com/currentslab/awesome-vector-search) | awesome | ベクトル検索 | 1564 | 2024-08 | ベクトル検索のライブラリ・サービス・論文集(Faiss, Annoy等) |
...
| 鮮度 | リポジトリ | 種別 | サブ分野 | ⭐ | 最終更新 | 説明 |
|:--:|:--|:--|:--|--:|:--:|:--|
| 🟢 | [EthicalML/awesome-production-machine-learning](https://github.com/EthicalML/awesome-production-machine-learning) | awesome | MLシステム | 20582 | 2026-05 | MLのデプロイ・監視・スケーリング用OSSライブラリのリスト |
| 🟢 | [kelvins/awesome-mlops](https://github.com/kelvins/awesome-mlops) | awesome | MLOps | 5158 | 2026-04 | MLOpsツールのキュレーションリスト |
| 🟢 | [Guang000/Awesome-Dataset-Distillation](https://github.com/Guang000/Awesome-Dataset-Distillation) | awesome | データセット蒸留 | 1937 | 2026-05 | 勾配/分布マッチング・生成手法・応用を網羅した定番リスト(非常に活発) |
...
| 🟡 | [HumanSignal/awesome-data-labeling](https://github.com/HumanSignal/awesome-data-labeling) | awesome | データラベリング | 4328 | 2024-06 | データラベリングツールを厳選したリスト |
...
| 🟡 | [HazyResearch/data-centric-ai](https://github.com/HazyResearch/data-centric-ai) | awesome | データ中心AI | 1144 | 2023-12 | データ中心AIのリソース集(Stanford HazyResearch) |
...
| 🟢 | [ahammadmejbah/Awesome-Datasets-Hub](https://github.com/ahammadmejbah/Awesome-Datasets-Hub) | awesome | データセット | 135 | 2026-05 | 医療AI・NLP・マルチモーダル等のLLM向けデータセット集 |
